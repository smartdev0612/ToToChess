<?php
$d2_oe = $TPL_VAR["mini_odds"]["d2_oe"];
$d2_lr = $TPL_VAR["mini_odds"]["d2_lr"];
$d2_line = $TPL_VAR["mini_odds"]["d2_line"];
$d2_oeline_lr = $TPL_VAR["mini_odds"]["d2_oeline_lr"];
?>

<script>
    var limit_time = <?php echo $TPL_VAR["mini_config"]["dari2_limit"]?>;
    <?php if($TPL_VAR["mini_config"]["dari2"] == 0) {?>
        alert('이다리 미니게임은 현재 점검중입니다.\n이용에 불편을 드려 죄송합니다.');
        document.location.href='/';
    <?php } ?>
</script>

<div class="ladder_wrap" style="background: url(/img/m/bg_ladder.png) repeat">
	<div class="ladder_top" style="margin-left:50px;">
		<div class="ladder_area" style="width:810px; top:-92px !important; left:-110px; ">
			<iframe id="game_frame" src="http://scoregame.co.kr/game/ladder2/game" frameborder="0" border="0" scrolling="no" style="width:100%; height:700px;"></iframe>
		</div>
	</div>
	...
	<div class="ladder_cnt">
		...
		<!-- 게임선택 -->
			...
			<div class="ladder_1st">
				...
				<div>
					<ul>
						<li><input type="button" value="<?php echo $d2_oe?>" class="b_odd" onclick="gameSelect('odd','<?php echo $d2_oe?>');" id="gameSt_odd"></li>
						<li><input type="button" value="<?php echo $d2_oe?>" class="b_even" onclick="gameSelect('even','<?php echo $d2_oe?>');" id="gameSt_even"></li>
					</ul>
				</div>
			</div>
			<div class="ladder_2nd">
				...
				<div>
					<ul>
						<li><input type="button" value="<?php echo $d2_lr?>" class="b_lft" onclick="gameSelect('left','<?php echo $d2_lr?>');" id="gameSt_left"></li>
						<li><input type="button" value="<?php echo $d2_lr?>" class="b_rgt" onclick="gameSelect('right','<?php echo $d2_lr?>');" id="gameSt_right"></li>
						<li><input type="button" value="<?php echo $d2_line?>" class="b_3_odd" onclick="gameSelect('3line','<?php echo $d2_line?>');" id="gameSt_3line"></li>
						<li><input type="button" value="<?php echo $d2_line?>" class="b_4_even" onclick="gameSelect('4line','<?php echo $d2_line?>');" id="gameSt_4line"></li>
					</ul>
				</div>
			</div>
			<div class="ladder_3rd">
				...
				<div class="brnone">
					<ul>
						...
						<li><input type="button" value="<?php echo $d2_oeline_lr?>" class="b_lft_3_oven" onclick="gameSelect('even3line_left','<?php echo $d2_oeline_lr?>');" id="gameSt_even3line_left"></li>
						<li><input type="button" value="<?php echo $d2_oeline_lr?>" class="b_lft_4_odd" onclick="gameSelect('odd4line_left','<?php echo $d2_oeline_lr?>');" id="gameSt_odd4line_left"></li>
						<li><input type="button" value="<?php echo $d2_oeline_lr?>" class="b_rgt_3_odd" onclick="gameSelect('odd3line_right','<?php echo $d2_oeline_lr?>');" id="gameSt_odd3line_right"></li>
						<li><input type="button" value="<?php echo $d2_oeline_lr?>" class="b_rgt_4_even" onclick="gameSelect('even4line_right','<?php echo $d2_oeline_lr?>');" id="gameSt_even4line_right"></li>

<!--						<li><input type="button" value="3.60" class="b_lft_3_oven" onclick="alert('3게임 배팅이 중단 되었습니다. 고객센터로 문의주세요.');" id="gameSt_even3line_left"></li>
						<li><input type="button" value="3.60" class="b_lft_4_odd" onclick="alert('3게임 배팅이 중단 되었습니다. 고객센터로 문의주세요.');" id="gameSt_odd4line_left"></li>
						<li><input type="button" value="3.60" class="b_rgt_3_odd" onclick="alert('3게임 배팅이 중단 되었습니다. 고객센터로 문의주세요.');" id="gameSt_odd3line_right"></li>
						<li><input type="button" value="3.60" class="b_rgt_4_even" onclick="alert('3게임 배팅이 중단 되었습니다. 고객센터로 문의주세요.');" id="gameSt_even4line_right"></li>-->
					</ul>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="/scripts/bet/2dari.js?v=<?=time();?>"></script>
<script>
