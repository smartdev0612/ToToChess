<?php
$d3_oe = $TPL_VAR["mini_odds"]["d3_oe"];
$d3_lr = $TPL_VAR["mini_odds"]["d3_lr"];
$d3_line = $TPL_VAR["mini_odds"]["d3_line"];
$d3_oeline_lr = $TPL_VAR["mini_odds"]["d3_oeline_lr"];
?>

<script>
    var limit_time = <?php echo $TPL_VAR["mini_config"]["dari3_limit"]?>;
    <?php if($TPL_VAR["mini_config"]["dari3"] == 0) {?>
        alert('삼다리 미니게임은 현재 점검중입니다.\n이용에 불편을 드려 죄송합니다.');
        document.location.href='/';
    <?php } ?>
</script>

<div class="ladder_wrap" style="background: url(/img/m/bg_ladder.png) repeat">
	<div class="ladder_top" style="margin-left:25px;">
		<div class="ladder_area" style="width:810px; top:-115px !important; left:-10px; ">
			<iframe id="game_frame" src="http://scoregame.co.kr/game/ladder3/game" frameborder="0" border="0" scrolling="no" style="width:100%; height:700px;"></iframe>
		</div>
	</div>
	...
	<div class="ladder_cnt">
		...
		<!-- 게임선택 -->
			...
			<div class="ladder_1st">
				...
				<div>
					<ul>
						<li><input type="button" value="<?php echo $d3_oe?>" class="b_odd" onclick="gameSelect('odd','<?php echo $d3_oe?>');" id="gameSt_odd"></li>
						<li><input type="button" value="<?php echo $d3_oe?>" class="b_even" onclick="gameSelect('even','<?php echo $d3_oe?>');" id="gameSt_even"></li>
					</ul>
				</div>
			</div>
			<div class="ladder_2nd">
				...
				<div>
					<ul>
						<li><input type="button" value="<?php echo $d3_lr?>" class="b_lft" onclick="gameSelect('left','<?php echo $d3_lr?>');" id="gameSt_left"></li>
						<li><input type="button" value="<?php echo $d3_lr?>" class="b_rgt" onclick="gameSelect('right','<?php echo $d3_lr?>');" id="gameSt_right"></li>
						<li><input type="button" value="<?php echo $d3_line?>" class="b_3_odd" onclick="gameSelect('3line','<?php echo $d3_line?>');" id="gameSt_3line"></li>
						<li><input type="button" value="<?php echo $d3_line?>" class="b_4_even" onclick="gameSelect('4line','<?php echo $d3_line?>');" id="gameSt_4line"></li>
					</ul>
				</div>
			</div>
			<div class="ladder_3rd">
				...
				<div class="brnone">
					<ul>
						...
						<li><input type="button" value="<?php echo $d3_oeline_lr?>" class="b_lft_3_oven" onclick="gameSelect('even3line_left','<?php echo $d3_oeline_lr?>');" id="gameSt_even3line_left"></li>
						<li><input type="button" value="<?php echo $d3_oeline_lr?>" class="b_lft_4_odd" onclick="gameSelect('odd4line_left','<?php echo $d3_oeline_lr?>');" id="gameSt_odd4line_left"></li>
						<li><input type="button" value="<?php echo $d3_oeline_lr?>" class="b_rgt_3_odd" onclick="gameSelect('odd3line_right','<?php echo $d3_oeline_lr?>');" id="gameSt_odd3line_right"></li>
						<li><input type="button" value="<?php echo $d3_oeline_lr?>" class="b_rgt_4_even" onclick="gameSelect('even4line_right','<?php echo $d3_oeline_lr?>');" id="gameSt_even4line_right"></li>
...
<script type="text/javascript" src="/scripts/bet/3dari.js?v=<?=time();?>"></script>
<script>
