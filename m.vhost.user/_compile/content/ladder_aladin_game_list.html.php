...
<div class="ladder_wrap" style="background: url(/img/m/bg_ladder.png) repeat">
	<div class="ladder_top">
		<div class="ladder_area" style="width:1000px; top:-130px;">
			<iframe id="game_frame" src="http://www.hafline.com/Theme/Ladder/Game.aspx" frameborder="0" border="0" scrolling="no" style="width:100%; height:700px;"></iframe>
		</div>
	</div>
...
<!--
						<li><input type="button" value="3.70" class="b_lft_3_oven" onclick="alert('3게임 배팅이 중단 되었습니다. 고객센터로 문의주세요.');" id="gameSt_even3line_left"></li>
						<li><input type="button" value="3.70" class="b_lft_4_odd" onclick="alert('3게임 배팅이 중단 되었습니다. 고객센터로 문의주세요.');" id="gameSt_odd4line_left"></li>
						<li><input type="button" value="3.70" class="b_rgt_3_odd" onclick="alert('3게임 배팅이 중단 되었습니다. 고객센터로 문의주세요.');" id="gameSt_odd3line_right"></li>
						<li><input type="button" value="3.70" class="b_rgt_4_even" onclick="alert('3게임 배팅이 중단 되었습니다. 고객센터로 문의주세요.');" id="gameSt_even4line_right"></li>
-->
					</ul>
				</div>
			</div>
...
<script type="text/javascript" src="/scripts/bet/aladin.js?v=<?=time();?>"></script>
<script>
