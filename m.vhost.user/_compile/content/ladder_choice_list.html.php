...
<div class="ladder_wrap" style="background: url(/img/m/bg_ladder.png) repeat">
	<div class="ladder_top" style="height: 420px;">
		<div style="position: relative;width: 100%;">
			<iframe id="game_frame" src="https://gamenlives.com/choice/choice.php" frameborder="0" border="0" scrolling="no"
	...
	<div class="ladder_cnt">
		...
		<!-- 게임선택 -->
			...
			<div class="ladder_1st">
				<h4><span>1게임</span><strong>B/W</strong></h4>
				<div>
					<ul>
						<li><input type="button" value="<?php echo $choice_bw?>" class="b_joy_black" onclick="gameSelect('black','<?php echo $choice_bw?>');" id="gameSt_black"></li>
						<li><input type="button" value="<?php echo $choice_bw?>" class="b_joy_white" onclick="gameSelect('white','<?php echo $choice_bw?>');" id="gameSt_white"></li>
					</ul>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="/scripts/bet/choice.js?v=<?=time();?>"></script>
<script>
