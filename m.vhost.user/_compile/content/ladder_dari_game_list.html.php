...
<?php
	if ( $TPL_VAR["named_security_flag"] == 1 ) {
		echo "<div class=\"ladder_top\">
						<img src=\"/images/named_security.jpg\" width=\"100%\" style=\"padding-top:1%;\">
					</div>";
	} else {
		echo "<div class=\"ladder_top\" style=\"margin-left:14%;\">
						<div class=\"ladder_area\" style=\"left:-23%; \"><iframe id=\"game_frame\" src=\"http://named.com/games/dari/view.php\" frameborder=\"0\" border=\"0\" scrolling=\"no\" style=\"width:100%; height:600px;\"></iframe></div>
					</div>";
	}
?>	
...
<script type="text/javascript" src="/scripts/bet/dari.js?v=<?=time();?>"></script>
<script>
