...
<div class="ladder_wrap" style="background: url(/img/m/bg_ladder.png) repeat">
	<div class="ladder_top" style="left:50%; margin-left:-143px; height:270px;">
		<div class="ladder_area" style="width:809px; top:-10px !important; left:-93px; ">
			<iframe id="game_frame" src="http://ntry.com/scores/keno_ladder/live.php" frameborder="0" border="0" scrolling="no" style="width:100%; height:700px;"></iframe>
		</div>
	</div>
	...
	<div class="ladder_cnt">
		...
		<!-- 게임선택 -->
			...
			<div class="ladder_1st">
				...
				<div>
					<ul>
						<li><input type="button" value="<?php echo $ks_oe?>" class="b_odd" onclick="gameSelect('odd','<?php echo $ks_oe?>');" id="gameSt_odd"></li>
						<li><input type="button" value="<?php echo $ks_oe?>" class="b_even" onclick="gameSelect('even','<?php echo $ks_oe?>');" id="gameSt_even"></li>
					</ul>
				</div>
			</div>
			<div class="ladder_2nd">
				...
				<div>
					<ul>
						<li><input type="button" value="<?php echo $ks_lr?>" class="b_lft" onclick="gameSelect('left','<?php echo $ks_lr?>');" id="gameSt_left"></li>
						<li><input type="button" value="<?php echo $ks_lr?>" class="b_rgt" onclick="gameSelect('right','<?php echo $ks_lr?>');" id="gameSt_right"></li>
						<li><input type="button" value="<?php echo $ks_line?>" class="b_3_odd" onclick="gameSelect('3line','<?php echo $ks_line?>');" id="gameSt_3line"></li>
						<li><input type="button" value="<?php echo $ks_line?>" class="b_4_even" onclick="gameSelect('4line','<?php echo $ks_line?>');" id="gameSt_4line"></li>
					</ul>
				</div>
			</div>
			<div class="ladder_3rd">
				...
				<div class="brnone">
					<ul>
						<li><input type="button" value="<?php echo $ks_oeline_lr?>" class="b_lft_3_oven" onclick="gameSelect('even3line_left','<?php echo $ks_oeline_lr?>');" id="gameSt_even3line_left"></li>
						<li><input type="button" value="<?php echo $ks_oeline_lr?>" class="b_lft_4_odd" onclick="gameSelect('odd4line_left','<?php echo $ks_oeline_lr?>');" id="gameSt_odd4line_left"></li>
						<li><input type="button" value="<?php echo $ks_oeline_lr?>" class="b_rgt_3_odd" onclick="gameSelect('odd3line_right','<?php echo $ks_oeline_lr?>');" id="gameSt_odd3line_right"></li>
						<li><input type="button" value="<?php echo $ks_oeline_lr?>" class="b_rgt_4_even" onclick="gameSelect('even4line_right','<?php echo $ks_oeline_lr?>');" id="gameSt_even4line_right"></li>
					</ul>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="/scripts/bet/kenosadari.js?v=<?=time();?>"></script>
<script>
