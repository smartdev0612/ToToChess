...
<div class="ladder_wrap" style="background: url(/img/m/bg_ladder.png) repeat">
	<div class="ladder_top" style="height:277px;">
		<div class="ladder_area" style="width:883px; top:-73px !important;">
			<iframe id="game_frame" src="http://www.hafline.com/Theme/LowHI/Game.aspx" frameborder="0" border="0" scrolling="no" style="width:100%; height:700px;"></iframe>
		</div>
	</div>
	<div class="ladder_cnt">
		...
		<!-- 게임선택 -->
			...
			<div class="ladder_1st">
				<h4><span>1게임</span>로우/하이</h4>
				<div>
					<ul>
						<li><input type="button" value="1.95" class="b_odd" onclick="gameSelect('low','1.95');" id="gameSt_odd" style="background:url('/img/m/img_lowhiBtn.png') no-repeat; background-size:500px 650px; background-position:-125px -1px;"></li>
						<li><input type="button" value="1.95" class="b_even" onclick="gameSelect('hi','1.95');" id="gameSt_even"  style="background:url('/img/m/img_lowhiBtn.png') no-repeat; background-size:500px 650px; background-position:-125px -48px"></li>
					</ul>
				</div>
			</div>
			<div class="ladder_1st">
				<h4><span>2게임</span>홀/짝</h4>
				<div>
					<ul>
		...
		<div class="ladder_notice">
			<h4>알아두세요!</h4>
			<ul>
				<li>로하이 게임의 회차는 오전 0시 기준으로 회차가 초기화 됩니다.</li>
				<li>한번 베팅한 로하이게임은 베팅취소 및 베팅수정이 불가합니다.</li>
				...
				<li>로하이 게임의 모든 배당률은 당사의 운영정책에 따라 언제든지 상/하향 조정될 수 있습니다.</li>
				<li>본 서비스는 네임드 로하이게임 결과를 기준으로 정산처리됩니다.</li>
...
<script type="text/javascript" src="/scripts/bet/lowhi.js?v=<?=time();?>"></script>
<script>
