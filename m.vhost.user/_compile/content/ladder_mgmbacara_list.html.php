...
<div class="ladder_wrap">
	...
	<div style="height:503px"> <iframe src="http://a2.ozlive.com/mobile/iframe_baccarat1-1.html" frameborder="0" width="100%" height="503px" marginwidth="0" marginheight="0"> </iframe></div>
	...
	<div class="ladder_cnt">
		...
		<div class="ladder_choice">
			...
			<div class="ladder_1st">
				<h4><span>1게임</span><strong>승리게임</strong></h4>
				<div>
					<ul>
			...
			<div class="ladder_1st">
				<h4><span>2게임</span><strong>타이게임1</strong></h4>
				<div>
					<ul>
						<li><input type="button" value="7.90" class="b_player_pair" onclick="gameSelect('player_pair','7.90');" id="gameSt_player"></li>
						<li><input type="button" value="7.90" class="b_banker_pair" onclick="gameSelect('banker_pair','7.90');" id="gameSt_banker"></li>
					</ul>
				</div>
			</div>
			<div class="ladder_2nd">
				<h4 style="height:50px;"><span>3게임</span><strong>타이게임2</strong></h4>
				<div style="height:60px;">
					<ul>
						<li><input type="button" value="7.90" class="b_tai" onclick="gameSelect('tai','7.90');" id="gameSt_tai"></li>
					</ul>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="/scripts/bet/mgmbacara.js?v=<?=time();?>"></script>
<script>
	...
	$(document).ready(function() {
		...
		var h_size = w_size * 1.56;
		$("#game_frame").attr('width',w_size+'px');
		$("#game_frame").attr('height',h_size+'px');
