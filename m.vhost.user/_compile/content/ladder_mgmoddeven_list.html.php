...
<div class="ladder_wrap">
	...
	<div style="height:491px"> <iframe src="http://a3.ozlive.com/mobile/iframe1.html" frameborder="0" width="100%" height="491px" marginwidth="0" marginheight="0"> </iframe></div>
	...
	<div class="ladder_cnt">
		...
		<!-- 게임선택 -->
			...
			<div class="ladder_1st">
				<h4><span>1게임</span><strong>홀짝게임</strong></h4>
				<div>
					<ul>
			...
			<div class="ladder_2nd">
				<h4 style="height:50px;"><span>2게임</span><strong>타이게임</strong></h4>
				<div style="height:60px;">
					<ul>
						<li><input type="button" value="7.97" class="b_tai" onclick="gameSelect('tai','7.97');" id="gameSt_tai"></li>
					</ul>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="/scripts/bet/mgmoddeven.js?v=<?=time();?>"></script>
<script>
