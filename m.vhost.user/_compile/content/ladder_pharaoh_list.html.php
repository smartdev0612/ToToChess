...
<div class="ladder_wrap" style="background: url(/img/m/bg_ladder.png) repeat">
	<div class="ladder_top" style="height: 480px;">
		<div style="position: relative;width: 100%;">
			<iframe id="game_frame" src="https://gamenlives.com/pharaoh/pharaoh.php" frameborder="0" border="0" scrolling="no" style="width:100%; height:1245px;"></iframe>
		</div>
	</div>
	...
	<div class="ladder_cnt">
		...
		<!-- 게임선택 -->
			...
			<div class="ladder_1st">
				<h4><span>1게임</span><strong>H/S</strong></h4>
				<div>
					<ul>
						<li><input type="button" value="<?php echo $pharaoh_hs?>" class="b_joy_heart" onclick="gameSelect('heart','<?php echo $pharaoh_hs?>');" id="gameSt_heart"></li>
						<li><input type="button" value="<?php echo $pharaoh_hs?>" class="b_joy_spade" onclick="gameSelect('spade','<?php echo $pharaoh_hs?>');" id="gameSt_spade"></li>
					</ul>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="/scripts/bet/pharaoh.js?v=<?=time();?>"></script>
<script>
