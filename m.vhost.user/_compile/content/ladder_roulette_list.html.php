...
<div class="ladder_wrap" style="background: url(/img/m/bg_ladder.png) repeat">
	<div class="ladder_top" style="height: 420px;">
		<div style="position: relative;width: 100%;">
			<iframe id="game_frame" src="https://gamenlives.com/roulette/roulette.php" frameborder="0" border="0" scrolling="no" style="width: 100%;height: 1000px;"></iframe>
		</div>
	</div>
	...
	<div class="ladder_cnt">
		...
		<!-- 게임선택 -->
			...
			<div class="ladder_1st">
				<h4><span>1게임</span><strong>R/B</strong></h4>
				<div>
					<ul>
                        <li><input type="button" value="<?php echo $roulette_rb?>" class="b_joy_red" onclick="gameSelect('red','<?php echo $roulette_rb?>');" id="gameSt_red"></li>
                        <li><input type="button" value="<?php echo $roulette_rb?>" class="b_joy_black2" onclick="gameSelect('black','<?php echo $roulette_rb?>');" id="gameSt_black"></li>
					</ul>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="/scripts/bet/roulette.js?v=<?=time();?>"></script>
<script>
