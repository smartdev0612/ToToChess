...
class Request
{
	...
	function Connect()
	{
		global $smsServer, $smsPort, $smsTimeout;

		$this->Server = $smsServer;
		$this->Port = $smsPort;
		$this->Timeout = $smsTimeout;
	...
	function Submit()
	{
		global $smsEndOfCommand, $smsStatus, $sms_key, $Response;
