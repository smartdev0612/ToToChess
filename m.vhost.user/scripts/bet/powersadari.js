		...
		$.ajax({
			...
			success: function(res) {
				if ( typeof(res) == "object" ) {
					...
					//serverTime = Number(serverTime) + 136000;
	...
	function gameBetting() {
		...
		var postData = {"btGameName":"powersadari", "btGameTh":gameTh, "btMoney":bet_money, "btGameType":selectGameType};
