	...
	if ( count($TPL_VAR["logList"]) > 0 ) {
		...
		for ( $i = 0 ; $i < count($data) ; $i++ ) {
			...
			$htmlData .= "<table cellspacing=\"1\" class=\"tableStyle_normal2\" summary=\"현재 진행 회차\">
											...
											<tbody>
												<tr>
													<th rowspan='7' style='width:80px;'>다리다리<br />".$gameTh."회차<br /></th>
												...
												<tr>
													<td style='padding-right: 5px;padding-left: 15px;'>홀 배팅 정보</td>
													<td class='betTd' align='right'>".number_format($odd_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>짝 배팅 정보</td>
													<td class='betTd' align='right'>".number_format($even_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>3줄 배팅 정보</td>
													<td class='betTd' align='right'>".number_format($line3_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>4줄 배팅 정보</td>
													<td class='betTd' align='right'>".number_format($line4_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>좌 배팅 정보</td>
													<td class='betTd' align='right'>".number_format($left_money)."원</td>	
													<td style='padding-right: 5px;padding-left: 15px;'>우 배팅 정보</td>
													<td class='betTd' align='right'>".number_format($right_money)."원</td>		
												</tr>
												<tr>
													<td style='padding-right: 5px;padding-left: 15px;'>홀 발란스 금액</td>
													<td class='betTd' align='right'>".number_format($odd_hit_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>짝 발란스 금액</td>
													<td class='betTd' align='right'>".number_format($even_hit_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>3줄 발란스 금액</td>
													<td class='betTd' align='right'>".number_format($line3_bal_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>4줄 발란스 금액</td>
													<td class='betTd' align='right'>".number_format($line4_hit_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>좌 발란스 금액</td>
													<td class='betTd' align='right'>".number_format($left_hit_money)."원</td>	
													<td style='padding-right: 5px;padding-left: 15px;'>우 발란스 금액</td>
													<td class='betTd' align='right'>".number_format($right_hit_money)."원</td>		
												</tr>
												<tr>
													<td style='padding-right: 5px;padding-left: 15px;'>홀 받치는 금액</td>
													<td class='betTd' align='right'>".number_format($odd_hit_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>짝 받치는 금액</td>
													<td class='betTd' align='right'>".number_format($even_hit_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>3줄 받치는 금액</td>
													<td class='betTd' align='right'>".number_format($line3_hit_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>4줄 받치는 금액</td>
													<td class='betTd' align='right'>".number_format($line4_hit_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>좌 받치는 금액</td>
													<td class='betTd' align='right'>".number_format($left_hit_money)."원</td>	
													<td style='padding-right: 5px;padding-left: 15px;'>우 받치는 금액</td>
													<td class='betTd' align='right'>".number_format($right_hit_money)."원</td>		
												</tr>
												<tr>
													<td style='padding-right: 5px;padding-left: 15px;'>홀 발란스 이익</td>
													<td class='betTd' align='right'>".number_format($odd_win_bal_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>짝 발란스 이익</td>
													<td class='betTd' align='right'>".number_format($even_win_bal_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>3줄 발란스 이익</td>
													<td class='betTd' align='right'>".number_format($line3_win_bal_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>4줄 발란스 이익</td>
													<td class='betTd' align='right'>".number_format($line4_win_bal_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>좌 발란스 이익</td>
													<td class='betTd' align='right'>".number_format($left_win_bal_money)."원</td>	
													<td style='padding-right: 5px;padding-left: 15px;'>우 발란스 이익</td>
													<td class='betTd' align='right'>".number_format($right_win_bal_money)."원</td>		
												</tr>
												<tr>
													<td style='padding-right: 5px;padding-left: 15px;'>홀 받친 배당 이익</td>
													<td class='betTd' align='right'>".number_format($odd_win_hit_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>짝 받친 배당 이익</td>
													<td class='betTd' align='right'>".number_format($even_win_hit_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>3줄 받친 배당 이익</td>
													<td class='betTd' align='right'>".number_format($line3_win_hit_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>4줄 받친 배당 이익</td>
													<td class='betTd' align='right'>".number_format($line4_win_hit_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>좌 받친 배당 이익</td>
													<td class='betTd' align='right'>".number_format($left_win_hit_money)."원</td>	
													<td style='padding-right: 5px;padding-left: 15px;'>우 받친 배당 이익</td>
													<td class='betTd' align='right'>".number_format($right_win_hit_money)."원</td>		
												</tr>
												<tr>
													<td style='padding-right: 5px;padding-left: 15px;'>홀 받친 롤링 이익</td>
													<td class='betTd' align='right'>".number_format($odd_win_roll_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>짝 받친 롤링 이익</td>
													<td class='betTd' align='right'>".number_format($even_win_roll_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>3줄 받친 롤링 이익</td>
													<td class='betTd' align='right'>".number_format($line3_win_roll_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>4줄 받친 롤링 이익</td>
													<td class='betTd' align='right'>".number_format($line4_win_roll_money)."원</td>
													<td style='padding-right: 5px;padding-left: 15px;'>좌 받친 롤링 이익</td>
													<td class='betTd' align='right'>".number_format($left_win_roll_money)."원</td>	
													<td style='padding-right: 5px;padding-left: 15px;'>우 받친 롤링 이익</td>
...
<div class="wrap">
	<div id="route">
		<h5>다리다리 밸런스 > <b>밸런스 이전 회차정보</b></h5>
	</div>

	<h3>다리다리 밸런스 이전 회차정보</h3>
