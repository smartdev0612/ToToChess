            ...
            success: function(res) {
                if ( typeof(res) == "object" ) {
                    ...
                    else */
                    {
                        ...
                        //-> 발란스 배당 이익
                        var odd_win_bal_money = parseInt(((odd_bal_money + even_bal_money) - (odd_bal_money * res.sadari_rate)) / 2);
                        var even_win_bal_money = parseInt(((odd_bal_money + even_bal_money) - (even_bal_money * res.sadari_rate)) / 2);
                        var left_win_bal_money = parseInt(((left_bal_money + right_bal_money) - (left_bal_money * res.sadari_rate)) / 2);
                        var right_win_bal_money = parseInt(((left_bal_money + right_bal_money) - (right_bal_money * res.sadari_rate)) / 2);
                        var line3_win_bal_money = parseInt(((line3_bal_money + line4_bal_money) - (line3_bal_money * res.sadari_rate)) / 2);
                        var line4_win_bal_money = parseInt(((line3_bal_money + line4_bal_money) - (line4_bal_money * res.sadari_rate)) / 2);
                        ...
                        //-> 받친금액 배당 이익
                        var odd_win_hit_money = parseInt((odd_hit_money * res.top_sadari_rate) - (odd_hit_money * res.sadari_rate));
                        var even_win_hit_money = parseInt((even_hit_money * res.top_sadari_rate) - (even_hit_money * res.sadari_rate));
                        var left_win_hit_money = parseInt((left_hit_money * res.top_sadari_rate) - (left_hit_money * res.sadari_rate));
                        var right_win_hit_money = parseInt((right_hit_money * res.top_sadari_rate) - (right_hit_money * res.sadari_rate));
                        var line3_win_hit_money = parseInt((line3_hit_money * res.top_sadari_rate) - (line3_hit_money * res.sadari_rate));
                        var line4_win_hit_money = parseInt((line4_hit_money * res.top_sadari_rate) - (line4_hit_money * res.sadari_rate));
