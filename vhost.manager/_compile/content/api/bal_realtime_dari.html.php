<div class="wrap">
    ...
    <table cellspacing="1" class="tableStyle_normal2" summary="현재 진행 회차" style="letter-spacing:-0.1em;">
        ...
        <tbody>
        <tr>
            <th rowspan="6" style="width:80px;">다리다리<br /><span id="sadariTh2"></span>회차<br /><font color="red">(<span id="balType2">받치기</span>)</font></th>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">홀 배팅 정보</td>
            <td class="betTd" align='right'><span id="sum_odd_cnt">0</span>건 / <span id="sum_odd">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">짝 배팅 정보</td>
            <td class="betTd" align='right'><span id="sum_even_cnt">0</span>건 / <span id="sum_even">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">3줄 배팅 정보</td>
            <td class="betTd" align='right'><span id="sum_3line_cnt">0</span>건 / <span id="sum_3line">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">4줄 배팅 정보</td>
            <td class="betTd" align='right'><span id="sum_4line_cnt">0</span>건 / <span id="sum_4line">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">좌 배팅 정보</td>
            <td class="betTd" align='right'><span id="sum_left_cnt">0</span>건 / <span id="sum_left">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">우 배팅 정보</td>
            <td class="betTd" align='right'><span id="sum_right_cnt">0</span>건 / <span id="sum_right">0</span>원</td>
        </tr>
        <tr>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">홀 발란스 금액</td>
            <td class="betTd" align='right'><span id="odd_bal_money">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">짝 발란스 금액</td>
            <td class="betTd" align='right'><span id="even_bal_money">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">3줄 발란스 금액</td>
            <td class="betTd" align='right'><span id="line3_bal_money">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">4줄 발란스 금액</td>
            <td class="betTd" align='right'><span id="line4_bal_money">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">좌 발란스 금액</td>
            <td class="betTd" align='right'><span id="left_bal_money">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">우 발란스 금액</td>
            <td class="betTd" align='right'><span id="right_bal_money">0</span>원</td>
        </tr>
        <tr>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">홀 받치는 금액</td>
            <td class="betTd" align='right'><span id="odd_hit_money">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">짝 받치는 금액</td>
            <td class="betTd" align='right'><span id="even_hit_money">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">3줄 받치는 금액</td>
            <td class="betTd" align='right'><span id="line3_hit_money">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">4줄 받치는 금액</td>
            <td class="betTd" align='right'><span id="line4_hit_money">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">좌 받치는 금액</td>
            <td class="betTd" align='right'><span id="left_hit_money">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">우 받치는 금액</td>
            <td class="betTd" align='right'><span id="right_hit_money">0</span>원</td>
        </tr>
        <tr>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">홀 발란스 이익</td>
            <td class="betTd" align='right'><span id="odd_bal_win">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">짝 발란스 이익</td>
            <td class="betTd" align='right'><span id="even_bal_win">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">3줄 발란스 이익</td>
            <td class="betTd" align='right'><span id="line3_bal_win">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">4줄 발란스 이익</td>
            <td class="betTd" align='right'><span id="line4_bal_win">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">좌 발란스 이익</td>
            <td class="betTd" align='right'><span id="left_bal_win">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">우 발란스 이익</td>
            <td class="betTd" align='right'><span id="right_bal_win">0</span>원</td>
        </tr>
        <tr>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">홀 받친 배당 이익</td>
            <td class="betTd" align='right'><span id="odd_hit_win">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">짝 받친 배당 이익</td>
            <td class="betTd" align='right'><span id="even_hit_win">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">3줄 받친 배당 이익</td>
            <td class="betTd" align='right'><span id="line3_hit_win">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">4줄 받친 배당 이익</td>
            <td class="betTd" align='right'><span id="line4_hit_win">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">좌 받친 배당 이익</td>
            <td class="betTd" align='right'><span id="left_hit_win">0</span>원</td>
            <td style="padding-right: 5px;padding-left: 15px;background: paleturquoise;">우 받친 배당 이익</td>
        ...
        $.ajax({
            ...
            success: function(res) {
                if ( typeof(res) == "object" ) {
                    ...
                    $("#sadariTh, #sadariTh2").html(res.dari_gameTh);
                    ...
                    else */
                    {
                        ...
                        //-> 발란스 배당 이익
                        var odd_win_bal_money = parseInt(((odd_bal_money + even_bal_money) - (odd_bal_money * res.dari_rate)) / 2);
                        var even_win_bal_money = parseInt(((odd_bal_money + even_bal_money) - (even_bal_money * res.dari_rate)) / 2);
                        var left_win_bal_money = parseInt(((left_bal_money + right_bal_money) - (left_bal_money * res.dari_rate)) / 2);
                        var right_win_bal_money = parseInt(((left_bal_money + right_bal_money) - (right_bal_money * res.dari_rate)) / 2);
                        var line3_win_bal_money = parseInt(((line3_bal_money + line4_bal_money) - (line3_bal_money * res.dari_rate)) / 2);
                        var line4_win_bal_money = parseInt(((line3_bal_money + line4_bal_money) - (line4_bal_money * res.dari_rate)) / 2);
                        ...
                        //-> 받친금액 배당 이익
                        var odd_win_hit_money = parseInt((odd_hit_money * res.top_dari_rate) - (odd_hit_money * res.dari_rate));
                        var even_win_hit_money = parseInt((even_hit_money * res.top_dari_rate) - (even_hit_money * res.dari_rate));
                        var left_win_hit_money = parseInt((left_hit_money * res.top_dari_rate) - (left_hit_money * res.dari_rate));
                        var right_win_hit_money = parseInt((right_hit_money * res.top_dari_rate) - (right_hit_money * res.dari_rate));
                        var line3_win_hit_money = parseInt((line3_hit_money * res.top_dari_rate) - (line3_hit_money * res.dari_rate));
                        var line4_win_hit_money = parseInt((line4_hit_money * res.top_dari_rate) - (line4_hit_money * res.dari_rate));
                        ...
                        var right_win_roll_money = parseInt(right_hit_money * (res.top_parent_per / 100));
                        ...
                        if ( total_hit_money > 0 ) {
                            if ( res.dari_limitSec > 90 ) {
                                var betLimit = res.dari_limitSec - 90;
                                $("#top_betting_time").html("<font style='font-size:26px;'>"+betLimit+"초 후 "+res.dari_gameTh+"회차 상부 배팅 시작</font>");
                                $("#balStats").html("배팅 대기중");
                            } else if ( res.dari_limitSec <= 90 && res.dari_limitSec >= 60 && typeof(res.balData) != "object" ) {
                                var betLimit = res.dari_limitSec - 60;
                                $("#top_betting_time").html("<font style='font-size:26px;'>상부 배팅 중... [배팅시도 남은시간 : "+betLimit+"초]</font>");
                                $("#balStats").html("상부 배팅 중");
                            } else if ( res.dari_limitSec < 60 && typeof(res.balData) != "object" ) {
                                $("#top_betting_time").html("<font color='red' style='font-size:26px;'>"+res.dari_gameTh+"회차 상부 배팅 실패! [다음회차 남은시간 : "+res.dari_limitSec+"초]</font>");
                                ...
                                $("#top_betting_time").html("<font color='blue' style='font-size:26px;'>"+res.dari_gameTh+"회차 상부 배팅 완료! [다음회차 남은시간 : "+res.dari_limitSec+"초]</font>");
                            ...
                            var betLimit = res.dari_limitSec - 90;
                            if ( betLimit <= 0 ) {
                                $("#top_betting_time").html("<font style='font-size:26px;'>배팅 마감! [다음회차 남은시간 : "+res.dari_limitSec+"초]</font>");
                            } else {
