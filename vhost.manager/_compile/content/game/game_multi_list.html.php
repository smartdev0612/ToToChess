...
<div class="wrap">
	...
	<div id="betting_2">
        <ul id="tab">
            ...
            <li><a href="/game/gameMultiList?state=20" id="sport_2">스포츠 II</a></li>
        </ul>
    </div>
	<div id="search">
...
<?php }elseif($TPL_V1["special"]==3){?>사다리
<?php }elseif($TPL_V1["special"]==4){?>달팽이
<?php }elseif($TPL_V1["special"]==5){?>파워볼
