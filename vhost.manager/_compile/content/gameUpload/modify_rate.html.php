...
<body>
	...
	<div id="search">
		<div class="wrap2">
			...
			<form name=frmSrh method=post action="/gameUpload/modify_rate"> 
...
?>
					<tr class="<?=$addTrStyle;?>">
						<td><input id="ckbox_<?php echo $TPL_V1["child_sn"]?>" name="y_id[]" type="checkbox" value="<?php echo $TPL_V1["child_sn"]?>" onClick="select_to(this);"/></td>
...
<?php }?>
						<td><input id="ckboxBack_<?php echo $TPL_V1["child_sn"]?>" name="y_id_back[]" type="checkbox" value="<?php echo $TPL_V1["child_sn"]?>" onClick="select_to(this);"/></td>
					</tr>
<?php }}?>
			</tbody>
		</table>
