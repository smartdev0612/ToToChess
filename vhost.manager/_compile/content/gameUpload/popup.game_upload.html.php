...
<script>
    function select_delete()
    {
        ...
        if(child_sn.length>0)
        {
            if ( confirm("정말 삭제하시겠습니까?") ) {
                ...
                document.location="/gameUpload/popup_gameupload?"+param;
            } else {
                return;
            }
        }
    ...
    function select_modify_rate() {
        ...
        if(child_sn.length>0)
        {
            ...
            if ( confirm("선택한 경기를 [배당변경] 하시겠습니까?") ) {
                ...
                if ( state == "rateUpdate" ) {
                    document.location="/gameUpload/popup_gameupload?"+param+"&page="+<?php echo $TPL_VAR["page"]?>;
                } else {
                    document.location="/gameUpload/popup_gameupload?"+param;
                }
            } else {
    ...
    function onApply(child_sn)
    {
        var gameDate = $('#game_date_'+child_sn).val();
        var gameHour = $('#game_hour_'+child_sn).val();
        var gameTime = $('#game_time_'+child_sn).val();
        var homeRate = $('#home_rate_'+child_sn).val();
        var drawRate = $('#draw_rate_'+child_sn).val();
        var awayRate = $('#away_rate_'+child_sn).val();
        var homeScore = $('#home_score_'+child_sn).val();
        var awayScore = $('#away_score_'+child_sn).val();


        if(confirm("적용하시겠습니까?"))
        {
            param="child_sn="+child_sn+"&act=apply&gameDate="+gameDate+"&gameHour="+gameHour+"&gameTime="+gameTime+"&homeRate="+homeRate+
...
<div id="search">
    <div class="wrap_search">
        <form name=frmSrh method=post action="/gameUpload/popup_gameupload">
            ...
            foreach ( $TPL_VAR["list"] as $TPL_V1) {
                ...
                <td>
                    <?php /*if($TPL_V1["update_game_date"]){*/?><!--<span style="color:red;"><?php /*}*/?><?php /*if($TPL_V1["update_enable"]==0){*/?><span style="border-bottom:1px solid red;"><?php /*}*/?>--><?php /*echo sprintf("%s %s:%s",substr($TPL_V1["gameDate"],5),$TPL_V1["gameHour"],$TPL_V1["gameTime"])*/?>
                            <input id="game_date_<?php echo $TPL_V1["child_sn"]?>" name="game_date_<?php echo $TPL_V1["child_sn"]?>" value="<?php echo $TPL_V1["gameDate"]?>" style="width: 75px">
                            <input id="game_hour_<?php echo $TPL_V1["child_sn"]?>" name="game_hour_<?php echo $TPL_V1["child_sn"]?>" value="<?php echo $TPL_V1["gameHour"]?>" style="width: 17px"> :
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td width="35">
                                ...
                                echo "<input id='home_rate_{$TPL_V1["child_sn"]}' name='home_rate_{$TPL_V1["child_sn"]}' value='{$rate}' style='{$style}'>";
                                ?>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <a href="#" onclick="open_window('/game/popup_bet_list?child_sn=<?php echo $TPL_V1["child_sn"]?>&amp;select_no=1','1024','600')">
                                <span style="color:#3163C9;" id="h_t_b_<?php echo $TPL_V1["child_sn"]?>"><?=number_format($TPL_V1["home_total_betting"],0);?></span>
                                </a>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%">
                        <tr>
                            <td>
                                ...
                                echo "<input id='draw_rate_{$TPL_V1["child_sn"]}' name='draw_rate_{$TPL_V1["child_sn"]}' value='{$rate}' style='{$style}'>";
                        ...
                        <tr>
                            <td>
                                <a href="#" onclick="open_window('/game/popup_bet_list?child_sn=<?php echo $TPL_V1["child_sn"]?>&amp;select_no=3','1024','600')">
                                <span style="color:#3163C9;" id="d_t_b_<?php echo $TPL_V1["child_sn"]?>"><?=number_format($TPL_V1["draw_total_betting"],0);?></span>
                                </a>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%">
                        <tr>
                            <td width="35">
                                ...
                                echo "<input id='away_rate_{$TPL_V1["child_sn"]}' name='away_rate_{$TPL_V1["child_sn"]}' value='{$rate}' style='{$style}'>";
                                ?>
                            </td>
                            <td>
                                <?php
                        ...
                        <tr>
                            <td colspan="2">
                                <a href="#" onclick="open_window('/game/popup_bet_list?child_sn=<?php echo $TPL_V1["child_sn"]?>&amp;select_no=2','1024','600')">
                                <span style="color:#3163C9;" id="a_t_b_<?php echo $TPL_V1["child_sn"]?>"><?=number_format($TPL_V1["away_total_betting"],0);?></span>
                                </a>
                            </td>
                        </tr>
                    </table>
                ...
                <td>
                    ...
                    echo "<input id='home_score_{$TPL_V1["child_sn"]}' name='home_score_{$TPL_V1["child_sn"]}' value='{$TPL_V1["home_score"]}' style='width: 40px;text-align: center'> : ";
                    echo "<input id='away_score_{$TPL_V1["child_sn"]}' name='away_score_{$TPL_V1["child_sn"]}' value='{$TPL_V1["away_score"]}' style='width: 40px;text-align: center'>";
                    ?>
                </td>
                <td>
                ...
                <td >
                    <a href="#" onclick="open_window('/game/popup_bet_list?child_sn=<?php echo $TPL_V1["child_sn"]?>&amp;','1024','600')" style="color: red">
                        <span id="t_t_b_<?php echo $TPL_V1["child_sn"]?>">
                ...
                <?php if($TPL_V1["kubun"]!=1){?>
                    <input type='button' class='btnStyle4' value="적용" onclick=onApply(<?php echo $TPL_V1["child_sn"]?>)>
                <?php } ?>
                </td>
                <td>
                    ...
                    <?php }else{?>
                        <input type='button' class="btnStyle3" value="결과취소" style="color:red" onclick="go_rollback('/gameUpload/popup_cancel_resultProcess?idx=<?php echo $TPL_V1["child_sn"]?>&type=<?php echo $TPL_VAR["type"]?>')")>
                    <?php }?>
                </td>
