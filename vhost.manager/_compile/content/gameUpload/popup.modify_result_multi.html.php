...
<form action="/gameUpload/modifyProcessMulti" method="post" name="EditForm">
	...
	<table cellspacing="1" class="tableStyle_membersWrite">	
        <tr>
			<th>종목선택</th>
			<td>
				<select id="category" name="category"  onchange="changeGameType()">
		...
		<tr>
			...
			<td>
				<select id="game_type" name="game_type">
                    <?php 
                    $options = "";
                    switch ($TPL_VAR["item"]['sport_name']) {
                        case "축구":
                            switch ($TPL_VAR["item"]['betting_type']) {
                                case "1":
                                    $options .= "<option value='1' selected>승패</option>";
                                    $options .= "<option value='2'>핸디캡</option>";
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4'>승무패</option>";
                                    $options .= "<option value='5'>승무패(전반)</option>";
                                    $options .= "<option value='6'>승무패(후반)</option>";
                                    $options .= "<option value='7'>언더오버(전반)</option>";
                                    $options .= "<option value='8'>언더오버(후반)</option>";
                                    $options .= "<option value='9'>득점홀짝</option>";
                                    $options .= "<option value='10'>득점홀짝(전반)</option>";
                                    break;
                                case "2":
                                    $options .= "<option value='1'>승패</option>";
                                    $options .= "<option value='2' selected>핸디캡</option>";
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4'>승무패</option>";
                                    $options .= "<option value='5'>승무패(전반)</option>";
                                    $options .= "<option value='6'>승무패(후반)</option>";
                                ...
                                case "3":
                                    $options .= "<option value='1'>승패</option>";
                                    $options .= "<option value='2'>핸디캡</option>";
                                    $options .= "<option value='3' selected>언더오버</option>";
                                    $options .= "<option value='4'>승무패</option>";
                                    $options .= "<option value='5'>승무패(전반)</option>";
                                    $options .= "<option value='6'>승무패(후반)</option>";
                                    $options .= "<option value='7'>언더오버(전반)</option>";
                                ...
                                case "4":
                                    ...
                                    $options .= "<option value='2'>핸디캡</option>";
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4' selected>승무패</option>";
                                    $options .= "<option value='5'>승무패(전반)</option>";
                                    $options .= "<option value='6'>승무패(후반)</option>";
                                    $options .= "<option value='7'>언더오버(전반)</option>";
                                    $options .= "<option value='8'>언더오버(후반)</option>";
                                ...
                                case "5":
                                    ...
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4'>승무패</option>";
                                    $options .= "<option value='5' selected>승무패(전반)</option>";
                                    $options .= "<option value='6'>승무패(후반)</option>";
                                    $options .= "<option value='7'>언더오버(전반)</option>";
                                    $options .= "<option value='8'>언더오버(후반)</option>";
                                    $options .= "<option value='9'>득점홀짝</option>";
                                ...
                                case "6":
                                    ...
                                    $options .= "<option value='4'>승무패</option>";
                                    $options .= "<option value='5'>승무패(전반)</option>";
                                    $options .= "<option value='6' selected>승무패(후반)</option>";
                                    $options .= "<option value='7'>언더오버(전반)</option>";
                                    $options .= "<option value='8'>언더오버(후반)</option>";
                                    $options .= "<option value='9'>득점홀짝</option>";
                                    $options .= "<option value='10'>득점홀짝(전반)</option>";
                                ...
                                case "7":
                                    ...
                                    $options .= "<option value='5'>승무패(전반)</option>";
                                    $options .= "<option value='6'>승무패(후반)</option>";
                                    $options .= "<option value='7' selected>언더오버(전반)</option>";
                                    $options .= "<option value='8'>언더오버(후반)</option>";
                                    $options .= "<option value='9'>득점홀짝</option>";
                                    $options .= "<option value='10'>득점홀짝(전반)</option>";
                                    break;
                                case "8":
                                    ...
                                    $options .= "<option value='6'>승무패(후반)</option>";
                                    $options .= "<option value='7'>언더오버(전반)</option>";
                                    $options .= "<option value='8' selected>언더오버(후반)</option>";
                                    $options .= "<option value='9'>득점홀짝</option>";
                                    $options .= "<option value='10'>득점홀짝(전반)</option>";
                                    break;
                                case "9":
                                    ...
                                    $options .= "<option value='7'>언더오버(전반)</option>";
                                    $options .= "<option value='8'>언더오버(후반)</option>";
                                    $options .= "<option value='9' selected>득점홀짝</option>";
                                    $options .= "<option value='10'>득점홀짝(전반)</option>";
                                    break;
                                case "10":
                                    $options .= "<option value='1'>승패</option>";
                                    ...
                                    $options .= "<option value='8'>언더오버(후반)</option>";
                                    $options .= "<option value='9'>득점홀짝</option>";
                                    $options .= "<option value='10' selected>득점홀짝(전반)</option>";
                                    break;
                            }
                            break;
                        case "농구":
                            switch ($TPL_VAR["item"]['betting_type']) {
                                case "1":
                                    ...
                                    $options .= "<option value='2'>핸디캡</option>";
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4'>승무패(1쿼터)</option>";
                                    $options .= "<option value='5'>승무패(2쿼터)</option>";
                                    $options .= "<option value='6'>승무패(3쿼터)</option>";
                                    $options .= "<option value='7'>승무패(4쿼터)</option>";
                                    $options .= "<option value='8'>핸디캡(1쿼터)</option>";
                                    $options .= "<option value='9'>핸디캡(2쿼터)</option>";
                                    $options .= "<option value='10'>핸디캡(3쿼터)</option>";
                                    $options .= "<option value='11'>핸디캡(4쿼터)</option>";
                                    $options .= "<option value='12'>언더오버(1쿼터)</option>";
                                    $options .= "<option value='13'>언더오버(2쿼터)</option>";
                                    $options .= "<option value='14'>언더오버(3쿼터)</option>";
                                    $options .= "<option value='15'>언더오버(4쿼터)</option>";
                                    break;
                                case "2":
                                    $options .= "<option value='1'>승패</option>";
                                    $options .= "<option value='2' selected>핸디캡</option>";
                                ...
                                case "4":
                                    ...
                                    $options .= "<option value='2'>핸디캡</option>";
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4' selected>승무패(1쿼터)</option>";
                                    $options .= "<option value='5'>승무패(2쿼터)</option>";
                                    $options .= "<option value='6'>승무패(3쿼터)</option>";
                                    $options .= "<option value='7'>승무패(4쿼터)</option>";
                                    $options .= "<option value='8'>핸디캡(1쿼터)</option>";
                                ...
                                case "5":
                                    ...
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4'>승무패(1쿼터)</option>";
                                    $options .= "<option value='5' selected>승무패(2쿼터)</option>";
                                    $options .= "<option value='6'>승무패(3쿼터)</option>";
                                    $options .= "<option value='7'>승무패(4쿼터)</option>";
                                    $options .= "<option value='8'>핸디캡(1쿼터)</option>";
                                    $options .= "<option value='9'>핸디캡(2쿼터)</option>";
                                ...
                                case "6":
                                    ...
                                    $options .= "<option value='4'>승무패(1쿼터)</option>";
                                    $options .= "<option value='5'>승무패(2쿼터)</option>";
                                    $options .= "<option value='6' selected>승무패(3쿼터)</option>";
                                    $options .= "<option value='7'>승무패(4쿼터)</option>";
                                    $options .= "<option value='8'>핸디캡(1쿼터)</option>";
                                    $options .= "<option value='9'>핸디캡(2쿼터)</option>";
                                    $options .= "<option value='10'>핸디캡(3쿼터)</option>";
                                ...
                                case "7":
                                    ...
                                    $options .= "<option value='5'>승무패(2쿼터)</option>";
                                    $options .= "<option value='6'>승무패(3쿼터)</option>";
                                    $options .= "<option value='7' selected>승무패(4쿼터)</option>";
                                    $options .= "<option value='8'>핸디캡(1쿼터)</option>";
                                    $options .= "<option value='9'>핸디캡(2쿼터)</option>";
                                    $options .= "<option value='10'>핸디캡(3쿼터)</option>";
                                    $options .= "<option value='11'>핸디캡(4쿼터)</option>";
                                ...
                                case "8":
                                    ...
                                    $options .= "<option value='6'>승무패(3쿼터)</option>";
                                    $options .= "<option value='7'>승무패(4쿼터)</option>";
                                    $options .= "<option value='8' selected>핸디캡(1쿼터)</option>";
                                    $options .= "<option value='9'>핸디캡(2쿼터)</option>";
                                    $options .= "<option value='10'>핸디캡(3쿼터)</option>";
                                    $options .= "<option value='11'>핸디캡(4쿼터)</option>";
                                    $options .= "<option value='12'>언더오버(1쿼터)</option>";
                                ...
                                case "9":
                                    ...
                                    $options .= "<option value='7'>승무패(4쿼터)</option>";
                                    $options .= "<option value='8'>핸디캡(1쿼터)</option>";
                                    $options .= "<option value='9' selected>핸디캡(2쿼터)</option>";
                                    $options .= "<option value='10'>핸디캡(3쿼터)</option>";
                                    $options .= "<option value='11'>핸디캡(4쿼터)</option>";
                                    $options .= "<option value='12'>언더오버(1쿼터)</option>";
                                    $options .= "<option value='13'>언더오버(2쿼터)</option>";
                                ...
                                case "10":
                                    ...
                                    $options .= "<option value='8'>핸디캡(1쿼터)</option>";
                                    $options .= "<option value='9'>핸디캡(2쿼터)</option>";
                                    $options .= "<option value='10' selected>핸디캡(3쿼터)</option>";
                                    $options .= "<option value='11'>핸디캡(4쿼터)</option>";
                                    $options .= "<option value='12'>언더오버(1쿼터)</option>";
                                    $options .= "<option value='13'>언더오버(2쿼터)</option>";
                                    $options .= "<option value='14'>언더오버(3쿼터)</option>";
                                ...
                                case "11":
                                    ...
                                    $options .= "<option value='9'>핸디캡(2쿼터)</option>";
                                    $options .= "<option value='10'>핸디캡(3쿼터)</option>";
                                    $options .= "<option value='11' selected>핸디캡(4쿼터)</option>";
                                    $options .= "<option value='12'>언더오버(1쿼터)</option>";
                                    $options .= "<option value='13'>언더오버(2쿼터)</option>";
                                    $options .= "<option value='14'>언더오버(3쿼터)</option>";
                                    $options .= "<option value='15'>언더오버(4쿼터)</option>";
                                ...
                                case "12":
                                    ...
                                    $options .= "<option value='10'>핸디캡(3쿼터)</option>";
                                    $options .= "<option value='11'>핸디캡(4쿼터)</option>";
                                    $options .= "<option value='12' selected>언더오버(1쿼터)</option>";
                                    $options .= "<option value='13'>언더오버(2쿼터)</option>";
                                    $options .= "<option value='14'>언더오버(3쿼터)</option>";
                                    $options .= "<option value='15'>언더오버(4쿼터)</option>";
                                    break;
                                case "13":
                                    ...
                                    $options .= "<option value='11'>핸디캡(4쿼터)</option>";
                                    $options .= "<option value='12'>언더오버(1쿼터)</option>";
                                    $options .= "<option value='13' selected>언더오버(2쿼터)</option>";
                                    $options .= "<option value='14'>언더오버(3쿼터)</option>";
                                    $options .= "<option value='15'>언더오버(4쿼터)</option>";
                                    break;
                                case "14":
                                    ...
                                    $options .= "<option value='12'>언더오버(1쿼터)</option>";
                                    $options .= "<option value='13'>언더오버(2쿼터)</option>";
                                    $options .= "<option value='14' selected>언더오버(3쿼터)</option>";
                                    $options .= "<option value='15'>언더오버(4쿼터)</option>";
                                    break;
                                case "15":
                                    $options .= "<option value='1'>승패</option>";
                                    ...
                                    $options .= "<option value='13'>언더오버(2쿼터)</option>";
                                    $options .= "<option value='14'>언더오버(3쿼터)</option>";
                                    $options .= "<option value='15' selected>언더오버(4쿼터)</option>";
                                    break;
                            }
                            break;
                        case "배구":
                            switch ($TPL_VAR["item"]['betting_type']) {
                                case "1":
                                    ...
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4'>홀짝</option>";
                                    $options .= "<option value='5'>홀짝(1세트)</option>";
                                    break;
                                case "2":
                                    $options .= "<option value='1'>승패</option>";
                                    $options .= "<option value='2' selected>핸디캡</option>";
                                ...
                                case "4":
                                    ...
                                    $options .= "<option value='2'>핸디캡</option>";
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4' selected>홀짝</option>";
                                    $options .= "<option value='5'>홀짝(1세트)</option>";
                                    break;
                                case "5":
                                    $options .= "<option value='1'>승패</option>";
                                    ...
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4'>홀짝</option>";
                                    $options .= "<option value='5' selected>홀짝(1세트)</option>";
                                    break;
                            }
                            break;
                        case "야구":
                            switch ($TPL_VAR["item"]['betting_type']) {
                                case "1":
                                    ...
                                    $options .= "<option value='2'>핸디캡</option>";
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4'>승무패(1이닝)</option>";
                                    $options .= "<option value='5'>핸디캡(3이닝)</option>";
                                    $options .= "<option value='6'>핸디캡(5이닝)</option>";
                                    $options .= "<option value='7'>핸디캡(7이닝)</option>";
                                    $options .= "<option value='8'>언더오버(3이닝)</option>";
                                    $options .= "<option value='9'>언더오버(5이닝)</option>";
                                    $options .= "<option value='10'>언더오버(7이닝)</option>";
                                    break;
                                case "2":
                                    $options .= "<option value='1'>승패</option>";
                                    $options .= "<option value='2' selected>핸디캡</option>";
                                ...
                                case "4":
                                    ...
                                    $options .= "<option value='2'>핸디캡</option>";
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4' selected>승무패(1이닝)</option>";
                                    $options .= "<option value='5'>핸디캡(3이닝)</option>";
                                    $options .= "<option value='6'>핸디캡(5이닝)</option>";
                                    $options .= "<option value='7'>핸디캡(7이닝)</option>";
                                    $options .= "<option value='8'>언더오버(3이닝)</option>";
                                ...
                                case "5":
                                    ...
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4'>승무패(1이닝)</option>";
                                    $options .= "<option value='5' selected>핸디캡(3이닝)</option>";
                                    $options .= "<option value='6'>핸디캡(5이닝)</option>";
                                    $options .= "<option value='7'>핸디캡(7이닝)</option>";
                                    $options .= "<option value='8'>언더오버(3이닝)</option>";
                                    $options .= "<option value='9'>언더오버(5이닝)</option>";
                                ...
                                case "6":
                                    ...
                                    $options .= "<option value='4'>승무패(1이닝)</option>";
                                    $options .= "<option value='5'>핸디캡(3이닝)</option>";
                                    $options .= "<option value='6' selected>핸디캡(5이닝)</option>";
                                    $options .= "<option value='7'>핸디캡(7이닝)</option>";
                                    $options .= "<option value='8'>언더오버(3이닝)</option>";
                                    $options .= "<option value='9'>언더오버(5이닝)</option>";
                                    $options .= "<option value='10'>언더오버(7이닝)</option>";
                                ...
                                case "7":
                                    ...
                                    $options .= "<option value='5'>핸디캡(3이닝)</option>";
                                    $options .= "<option value='6'>핸디캡(5이닝)</option>";
                                    $options .= "<option value='7' selected>핸디캡(7이닝)</option>";
                                    $options .= "<option value='8'>언더오버(3이닝)</option>";
                                    $options .= "<option value='9'>언더오버(5이닝)</option>";
                                    $options .= "<option value='10'>언더오버(7이닝)</option>";
                                    break;
                                case "8":
                                    ...
                                    $options .= "<option value='6'>핸디캡(5이닝)</option>";
                                    $options .= "<option value='7'>핸디캡(7이닝)</option>";
                                    $options .= "<option value='8' selected>언더오버(3이닝)</option>";
                                    $options .= "<option value='9'>언더오버(5이닝)</option>";
                                    $options .= "<option value='10'>언더오버(7이닝)</option>";
                                    break;
                                case "9":
                                    ...
                                    $options .= "<option value='7'>핸디캡(7이닝)</option>";
                                    $options .= "<option value='8'>언더오버(3이닝)</option>";
                                    $options .= "<option value='9' selected>언더오버(5이닝)</option>";
                                    $options .= "<option value='10'>언더오버(7이닝)</option>";
                                    break;
                                case "10":
                                    $options .= "<option value='1'>승패</option>";
                                    ...
                                    $options .= "<option value='8'>언더오버(3이닝)</option>";
                                    $options .= "<option value='9'>언더오버(5이닝)</option>";
                                    $options .= "<option value='10' selected>언더오버(7이닝)</option>";
                                    break;
                            }
                            break;
                        case "하키":
                            switch ($TPL_VAR["item"]['betting_type']) {
                                case "1":
                                    ...
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4'>승무패</option>";
                                    $options .= "<option value='5'>승패(1피리어드)</option>";
                                    $options .= "<option value='6'>승무패(1피리어드)</option>";
                                    $options .= "<option value='7'>핸디캡(1피리어드)</option>";
                                    $options .= "<option value='8'>언더오버(1피리어드)</option>";
                                    break;
                                case "2":
                                    $options .= "<option value='1'>승패</option>";
                                    $options .= "<option value='2' selected>핸디캡</option>";
                                ...
                                case "5":
                                    ...
                                    $options .= "<option value='3'>언더오버</option>";
                                    $options .= "<option value='4'>승무패</option>";
                                    $options .= "<option value='5' selected>승패(1피리어드)</option>";
                                    $options .= "<option value='6'>승무패(1피리어드)</option>";
                                    $options .= "<option value='7'>핸디캡(1피리어드)</option>";
                                    $options .= "<option value='8'>언더오버(1피리어드)</option>";
                                    break;
                                case "6":
                                    ...
                                    $options .= "<option value='4'>승무패</option>";
                                    $options .= "<option value='5'>승패(1피리어드)</option>";
                                    $options .= "<option value='6' selected>승무패(1피리어드)</option>";
                                    $options .= "<option value='7'>핸디캡(1피리어드)</option>";
                                    $options .= "<option value='8'>언더오버(1피리어드)</option>";
                                    break;
                                case "7":
                                    ...
                                    $options .= "<option value='5'>승패(1피리어드)</option>";
                                    $options .= "<option value='6'>승무패(1피리어드)</option>";
                                    $options .= "<option value='7' selected>핸디캡(1피리어드)</option>";
                                    $options .= "<option value='8'>언더오버(1피리어드)</option>";
                                    break;
                                case "8":
                                    $options .= "<option value='1'>승패</option>";
                                    ...
                                    $options .= "<option value='6'>승무패(1피리어드)</option>";
                                    $options .= "<option value='7'>핸디캡(1피리어드)</option>";
                                    $options .= "<option value='8' selected>언더오버(1피리어드)</option>";
                                    break;
                            }
                            break;
                    }
...
<?php if($TPL_VAR["result"]!=1){?>
		...
		<tr name="result" id="result" style="display:none";>
			...
			<td>
				...
				<p class="contentMargin">
					자동<input type="hidden" name="bet_type" value="<?php echo trim($TPL_VAR["item"]["betting_type"])?>" style="border:1px #97ADCE solid;">
					<input type="radio" name="auto" onclick="autoSelect(<?php echo trim($TPL_VAR["item"]["betting_type"])?>, <?php echo $TPL_VAR["item"]["draw_rate"]?>)" value="0" class="radioMargin">
...
<?php if(trim($TPL_VAR["item"]["betting_type"])!=2){?>
...
<?php }?>
		<tr>
			<th>보임/숨김</th>
			<td>
				<select name="user_view_flag">
					<option value="0" <?php if($TPL_VAR["item"]["user_view_flag"]==='0'){?> selected <?php }?>>숨김</option>
					<option value="1" <?php if($TPL_VAR["item"]["user_view_flag"]==='1'){?> selected <?php }?>>보임</option>
				</select> ※ 유저 배팅리스트 숨김 기능.
			</td>
		</tr>
	</table>
