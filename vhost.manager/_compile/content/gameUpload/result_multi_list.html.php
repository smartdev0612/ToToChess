...
<body>
	...
	<div id="betting_2">
        <ul id="tab">
            <li><a href="/gameUpload/result_list" id="sport_1">스포츠 I</a></li>
            <li><a href="/gameUpload/result_multi_list" id="sport_2">스포츠 II</a></li>
        </ul>
    </div>
	<div id="search">
		<div class="wrap2">
			...
			<form name=frmSrh method=post action="/gameUpload/result_multi_list"> 
...
<?php if($TPL_list_1){$TPL_I1=-1;foreach($TPL_VAR["list"] as $TPL_V1){$TPL_I1++;?>
					<tr>
						<td><input name="y_id[]" type="checkbox" value="<?php echo $TPL_V1["subchild_sn"]?>" onClick="select_to(this);"/></td>
...
<?php }?>
						...
						<td>
							<input type="hidden" name="game_types[<?php echo $TPL_V1["subchild_sn"]?>]" value=<?php echo $TPL_V1["type"]?>>
							<?php 
							$detail_name = "";
							$home_score = "";
							$away_score = "";
						...
						<td><input type="text" id="home_rate" name="home_rate[<?php echo $TPL_V1["subchild_sn"]?>]" size="5" value="<?php echo $TPL_V1["home_rate"]?>" style="border:1px #97ADCE solid;" onkeyup='this.value=this.value.replace(/[^0-9.]/gi,"")'><br><?php echo number_format($TPL_V1["home_total_betting"],0)?></td>
						<td><input type="text" id="draw_rate" name="draw_rate[<?php echo $TPL_V1["subchild_sn"]?>]" size="5" value="<?php echo $TPL_V1["draw_rate"]?>" style="border:1px #97ADCE solid;"><br><?php echo number_format($TPL_V1["draw_total_betting"],0)?></td>
						<td><input type="text" id="away_rate" name="away_rate[<?php echo $TPL_V1["subchild_sn"]?>]" size="5" value="<?php echo $TPL_V1["away_rate"]?>" style="border:1px #97ADCE solid;" onkeyup='this.value=this.value.replace(/[^0-9.]/gi,"")'><br><?php echo number_format($TPL_V1["away_total_betting"],0)?></td>
<?php if($TPL_VAR["state"]!=3){?>
						<td><input type="checkbox" name="check_cancel[]" onclick='autoCheck_check(<?php echo $TPL_I1?>)' ></td>
						<td>
							<input type="text" name="home_score[<?php echo $TPL_V1["subchild_sn"]?>]" size="5" value="<?=$home_score?>" style="border:1px #97ADCE solid;" onkeyup='this.value=this.value.replace(/[^0-9.]/gi,"")' onblur='autoCheck(<?php echo $TPL_I1?>, this.value)'>
							:
							<input type="text" name="away_score[<?php echo $TPL_V1["subchild_sn"]?>]" size="5" value="<?=$away_score?>" style="border:1px #97ADCE solid;" onkeyup='this.value=this.value.replace(/[^0-9.]/gi,"")'>
						</td>
						<td>
...
<?php }?>
						<td><input name="y_id_back[]" type="checkbox" value="<?php echo $TPL_V1["subchild_sn"]?>" onClick="select_to(this);"/></td>
					</tr>
<?php }}?>
			</tbody>
		</table>
