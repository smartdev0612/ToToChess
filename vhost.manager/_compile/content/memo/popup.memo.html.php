<?php /* Template_ 2.2.3 2012/11/30 16:47:16 D:\www_one-23.com\vhost.manager\_template\content\memo\popup.memo.html */
		...
		<table cellspacing="1" class="tableStyle_normal" summary="받은 쪽지함">
			<legend class="blind">받은 쪽지함 - 내용</legend>
				<tr onClick="javascript:ShowFLT(<?php echo $TPL_V1["idx"]?>)">
					<td class="check">
						<input name="y_id[]" type="checkbox" id="y_id" value="<?php echo $TPL_V1["mem_idx"]?>"  onclick="javascript:chkRow(this);"/>
					</td>
					<td width="15%"><?php echo $TPL_V1["toid"]?></td>
					<td width="15%"><?php echo $TPL_V1["fromid"]?></td>
					<td width="34%">
						<span class="subject"><?php echo mb_strimwidth($TPL_V1["title"],0,36,"..","utf-8")?></span>
					</td>
...
<?php }?>	
					...
					<td width="20%">
						<a href="javascript:open_window('/memo/popup_write?userid=<?php echo $TPL_V1["fromid"]?>',650,340)"><img src="/img/btn_s_answer.gif" title="답변"></a>&nbsp;
						<a href="javascript:confirm('정말 삭제하시겠습니까?');location.href='/memo/popup_memo?act=onedel&idx=<?php echo $TPL_V1["mem_idx"]?>';"><img src="/img/btn_s_del.gif" title="삭제"></a>
					</td>
				</tr>
			</tbody>
		</table>
