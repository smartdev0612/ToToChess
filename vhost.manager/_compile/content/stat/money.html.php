...
<?php }?>
				...
				<td class="moneyTd">
					<a href="#" onclick="open_window('/stat/new_popup_moneyloglist?date=<?php echo $TPL_V1["current_date"]?>&filter_partner_sn=<?php echo $TPL_VAR["filter_partner_sn"]?>&filter_state=1&flag=0',1000,600)"><?php echo number_format($TPL_V1["charge"],0)?></a>
				</td>
				<td class="moneyTd">
					<a href="#" onclick="open_window('/stat/new_popup_moneyloglist?date=<?php echo $TPL_V1["current_date"]?>&filter_partner_sn=<?php echo $TPL_VAR["filter_partner_sn"]?>&filter_state=2&flag=1',1000,600)"><?php echo number_format($TPL_V1["exchange"],0)?></a>
				</td>
				<td class="moneyTd"><a href="#" onclick="open_window('/stat/popup_mileageloglist?date=<?php echo $TPL_V1["current_date"]?>&filter_partner_sn=<?php echo $TPL_VAR["filter_partner_sn"]?>&filter_state=20&flag=0',1000,600)"><?php echo number_format($TPL_V1["admin_tex_charge"],0)?></a></td>
				<td class="moneyTd">
...
<?php }}?>
	...
	<tfoot>
		<tr>
			...
			<td><?php echo number_format($TPL_VAR["sumList"]["sum_admin_tex_charge"],0)?></td>
