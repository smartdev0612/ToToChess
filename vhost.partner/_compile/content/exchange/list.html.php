<?php /* Template_ 2.2.3 2013/01/14 00:52:10 D:\www_one-23.com\vhost.partner\_template\content\exchange\list.html */
...
<?php if($TPL_select_rolling_list_1){foreach($TPL_VAR["select_rolling_list"] as $TPL_V1){?>
					  	<option value="<?php echo $TPL_V1["Idx"]?>" <?php if($TPL_VAR["filter_sn"]==$TPL_V1["Idx"]){?> selected<?php }?>><?php echo $TPL_V1["rec_id"]?></option>
<?php }}?>
					</select>
<?php }?>
				-->
