<?php /* Template_ 2.2.3 2014/08/15 17:03:26 D:\www_one-23.com\vhost.partner\_template\content\member\popup_live_game_betting_list.html */
  ...
  <form id="form1" name="form1" method="post" action="?act=delete_user">
	  <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF">
	    <tr style="padding-left:8px;">
	    	<td width="15%" align="center" bgcolor="#D0E2F7" >팀</td>
		    ...
		    <td width="5%" align="center"  bgcolor="#D0E2F7">종류</td>
		    <td width="5%" align="center"  bgcolor="#D0E2F7">베팅위치</td>
			...
			<td width="5%" align="center" bgcolor="#D0E2F7"  >당첨금액</td>
			<td width="5%" align="center" bgcolor="#D0E2F7"  >결과</td>
...
$TPL_item_2=empty($TPL_V1["item"])||!is_array($TPL_V1["item"])?0:count($TPL_V1["item"]);?>
	  		<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="link_lan">
					<tr  style="padding-left:8px;" id="t_<?php echo $TPL_V1["betting_no"]?>" onclick="on_click('<?php echo $TPL_V1["betting_no"]?>')" bgcolor="#f6f6f6" onMouseOver="this.style.backgroundColor='#e0eafe';" onMouseOut="this.style.backgroundColor=''">
						<td width="15%" align="center" height="34" style="border-bottom:1px #CCCCCC solid;color: #666666"><?php echo $TPL_V1["home_team"]?> <font color='blue'><b> VS </b></font> <?php echo $TPL_V1["away_team"]?></td>	
						<td width="10%" align="center" height="34" style="border-bottom:1px #CCCCCC solid;color: #666666"><?php echo $TPL_V1["betting_no"]?></td>	
						<td width="5%" align="center" height="34" style="border-bottom:1px #CCCCCC solid;color: #666666"><?php echo $TPL_V1["uid"]?></td>					
						<td width="5%" align="center" style="border-bottom:1px #CCCCCC solid;color: #666666"><?php echo $TPL_V1["nick"]?></td>
						<td width="5%" align="center" style="border-bottom:1px #CCCCCC solid;color: #666666"><?php echo $TPL_V1["alias"]?></td>
						<td width="5%" align="center" style="border-bottom:1px #CCCCCC solid;color: #666666"><?php echo $TPL_V1["betting_position"]?></td>
						<td width="5%" align="center" style="border-bottom:1px #CCCCCC solid;color: #666666"><?php echo number_format($TPL_V1["betting_money"],0)?></td>
						<td width="5%" align="center" style="border-bottom:1px #CCCCCC solid;color: #666666"><?php echo $TPL_V1["odd"]?></td>
						<td width="5%" align="center" style="border-bottom:1px #CCCCCC solid;color: #666666"><?php echo number_format(round($TPL_V1["betting_money"]*$TPL_V1["odd"]),0)?></td>
						<td width="5%" align="center" style="border-bottom:1px #CCCCCC solid;color: #666666"><?php echo number_format($TPL_V1["prize"],0)?></td>
						<td width="5%" align="center" style="border-bottom:1px #CCCCCC solid;color: #666666"><?php if($TPL_V1["betting_result"]=="WIN"){?>적중<?php }elseif($TPL_V1["betting_result"]=='LOS'){?>낙첨<?php }elseif($TPL_V1["betting_result"]=='CANCEL'){?>적특<?php }?></td>
						<td width="12%" align="center" style="border-bottom:1px #CCCCCC solid;color: #666666"><?php echo $TPL_V1["reg_time"]?></td>
					</tr>
				</table>
