...
<script>
	...
	function submit_tex_money(form) {
		if ( form.tex_exchange_money.value > rec_tex_money || rec_tex_money <= 0 ) {
			alert("보유정산금이 부족합니다.");
			return false;
		}
...
<div id="wrap">
	...
	<div id="search">	
		<div style="float:left;">
			<form name='form3' action='' method='POST' onsubmit="return on_click();">
			<span>날짜</span>
...
<?php
	...
	$sum_get_tex_money_top += $TPL_V1["get_tex_money_top"];
?>
		<tr>
...
?>
			...
			<td><?php echo number_format($TPL_V1["get_tex_money_top"])?></td>
		</tr>
<?php }}?>
	</tbody>
	<tfoot>
		<tr>
			...
			<td><?php echo number_format($sum_get_tex_money_top,0)?></td>
		 </tr>
	</tfoot>
	</table>
</div>