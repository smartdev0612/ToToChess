            ...
            <table cellpadding="0" cellspacing="0" border="0">
                ...
                ?>
                    <tr height="51">
                        ...
                        <td><?php if($TPL_V1["state"]==0){?>처리중<?php }elseif($TPL_V1["state"]==1){?>환전완료<?php }?></td>
                        <td><?php	if($TPL_V1["state"]==0){echo "-";} else if ( $TPL_V1["state"] == 1 ) {?><a href="/member/exchangelist?exchange_sn=<?php echo $TPL_V1["sn"]?>"><img src="/images/bt_del_1.png" alt="삭제"/></a><?php	}?></td>
                    </tr>
                <?php
                    }
                }
