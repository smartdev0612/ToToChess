...
<div id="contents">
   ...
   <div class="sports_head">
      ...
      <span class="sport_title">해외베팅시스템</span>
      <div class="menu_list2  margin-left-175">
         ...
         <ul class="list02">
            <li><button type="button" class="button_type01 button_border btn_all <?=($TPL_VAR['sport_type'] == '' ) ? 'on' : ''; ?>" onClick="getGameList('0')">ALL</button></li>
            <li><button type="button" class="button_type01 button_border btn_soccer <?= $TPL_VAR['sport_type'] == 'soccer' ? 'on' : ''; ?>" onClick="getGameList('0','soccer')"><img src="/10bet/images/10bet/ico/football-ico.png" alt="축구" /></button></li>
            <li><button type="button" class="button_type01 button_border btn_basketball <?= $TPL_VAR['sport_type'] == 'basketball' ? 'on' : ''; ?>" onClick="getGameList('0','basketball')"><img src="/10bet/images/10bet/ico/basketball-ico.png" alt="농구" /></button></li>
            <li><button type="button" class="button_type01 button_border btn_baseball <?= $TPL_VAR['sport_type'] == 'baseball' ? 'on' : ''; ?>" onClick="getGameList('0','baseball')"><img src="/10bet/images/10bet/ico/baseball-ico.png" alt="야구" /></button></li>
            <li><button type="button" class="button_type01 button_border btn_hockey <?= $TPL_VAR['sport_type'] == 'hockey' ? 'on' : ''; ?>" onClick="getGameList('0','hockey')"><img src="/10bet/images/10bet/ico/hockey-ico.png" alt="아이스 하키" /></button></li>
            <li><button type="button" class="button_type01 button_border btn_volleyball <?= $TPL_VAR['sport_type'] == 'volleyball' ? 'on' : ''; ?>" onClick="getGameList('0','volleyball')"><img src="/10bet/images/10bet/ico/volleyball-ico.png" alt="배구" /></button></li>
                                       ...
                                       <div class="width_100 bt_g_tabs">
                                          <div id="bonus_ul">
                                             ...
                                             <div class="bonus_item selectable" name="<?=$bonus["sn"]?>_div" onclick=onMultiTeamSelected('<?=$bonus["sn"]?>','0')>
                                                ...
                                                <span class="txt_co7"><?=$bonus["home_team"]?></span>
                                                <div class="bt_gr_area"><?=$bonus["home_rate"]?></div>
    ...
    */
    function onMultiTeamSelected($game_index, $index, $betid = 0) {
        ...
        if (toggle_action == 'inserted') {
            var item = new Item($game_index, $home_team, $away_team, $index, selectedRate, $home_rate, $draw_rate, $away_rate, $game_type, $sub_sn, $is_specified_special, $game_date, $league_sn, $sport_name, 0, $betid, member_sn);
                    ...
                    $.each(res, function(index, item) {
                        ...
                        $.ajax({
                            ...
                            success: function(response){
                                ...
                                div += '<span class="txt_co7">' + item.home_team + '</span>';
                                div += '<div class="bt_gr_area">' + response.home_rate + '</div>';
    ...
    function getGameList(page_index = 0, sport_type = "", league_sn = 0, today = 0) {
        ...
        for(var i = 0; i < showJson.length; i++) {
            ...
            if(json == null || json == undefined) {
                ...
                for(var j=0; j < showJson[i].m_lstDetail.length; j++) {
                    ...
                    // } else {
                    //     appendSubMarketDiv(showJson[i], showJson[i].m_lstDetail[j]);
                    // }
    ...
    function getSubChildInfo(index, item, detail, childCnt, isExist12) {
        ...
        switch(detail.m_nMarket) {
            case "1":
                ...
                break;
            case "3":
                homeAdd = "&nbsp;<span style='color:#ffa604'>[H]</span>";
                awayAdd = "<span style='color:#ffa604'>[H]</span>&nbsp;";
                break;
            case "2":
                homeAdd = "&nbsp;<img src='/10bet/images/10bet/dw.png' align='absmiddle'>";
                awayAdd = "<img src='/10bet/images/10bet/up.png' align='absmiddle'>&nbsp;";
                break;
        }
        div += '<div id="div_' + item.m_nGame + '">';
        div += '<ul class="clear">';
        div += '<li class="tr">';
        ...
        div += "<div class='st_wd44_l  txt_cut selectable' name='" + sub_idx + "_div' onclick=onMultiTeamSelected('" + sub_idx + "','0','" + detail.m_nHBetCode + "')>";
        div += item.m_strHomeTeam + homeAdd;
        ...
        div += '<input type="checkbox" name="ch" value="1" style="display:none;"></div>';
        if(detail.m_nMarket == 1) {
            div += "<div class='st_wd10_l txt_ac selectable' name='" + sub_idx + "_div' onclick=onMultiTeamSelected('" + sub_idx + "','1','" + detail.m_nDBetCode + "')>";
            ...
            div += '<div class="st_wd10_l txt_ac selectable" name="' + sub_idx + '_div">';
            //div += '<span id="' + item.child_sn + '_draw_rate">VS</span>';
            div += "VS";
            div += '<input type="checkbox" name="ch" value="3" style="display:none;"></div>';
        }
        div += "<div class='st_wd44_l  txt_cut selectable' name='" + sub_idx + "_div' onclick=onMultiTeamSelected('" + sub_idx + "','2','" + detail.m_nABetCode + "')>";
        //div += '<span id="' + item.child_sn + '_away_rate"></span>';
        div += '<span id="' + detail.m_nABetCode + '">' + detail.m_fARate.toFixed(2) + '</span>'; 
        div += '<span class="f_right">' + awayAdd + item.m_strAwayTeam + '</span>';
        div += '<input type="checkbox" name="ch" value="2" style="display:none;">';
        div += '</div></li></ul>';
        div += '</div>';
        $(".list_st1").append(div);
    }
    ...
    function div_1x2(children_array, header) {
        ...
        $.each(children_array, function(index, item) {
            ...
            children_div += '<input type="checkbox" name="ch" value="3" style="display:none;"></div>';
