   ...
   <div class="sports_head">
      ...
      <div class="menu_list2  margin-left-175">
         ...
         <ul class="list02">
            ...
            <li><button type="button" class="button_type01 button_border btn_esports <?= $TPL_VAR['sport_type'] == 'esports' ? 'on' : ''; ?>" onClick="getGameList('0','esports')"><img src="/10bet/images/10bet/ico/esport-ico.png" alt="E스포츠" /></button></li>
                                    ...
                                    <div class="st_con_left st_con_style1-1" id="gameLeft">
                                       ...
                                       <div class="width_100 bt_g_tabs">
                                          <div id="bonus_ul">
                                             ...
                                             <div class="bonus_item selectable" name="<?=$bonus["sn"]?>_div" onclick=onMultiTeamSelected('<?=$bonus["sn"]?>','0','0')>
