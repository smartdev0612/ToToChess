    ...
    <div class="sports_head">
        ...
        <div class="menu_list2">
            ...
            <ul class="list02 margin-left-175">
                ...
                <li><button type="button" class="button_type01 btn_esports <?= $TPL_VAR['sport_type'] == 'esports' ? 'on' : ''; ?>" onClick="getGameList('0','esports')"><img src="/10bet/images/10bet/ico/esport-ico.png" alt="E스포츠" /></button></li>
