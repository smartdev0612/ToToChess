				...
				<ul class="swiper-wrapper">
					...
					<li class="swiper-slide bg02">
						<div class="box01">
                            ...
                            <button onClick="location.href='/casino_slot'">PLAY NOW</button>
                        </div>
					</li>
					...
					<li class="swiper-slide bg04">
						<div class="box01">
							...
							<button onClick="location.href='/virtualgame'">PLAY NOW</button>
						</div>
					</li>
...
<div class="main_sports">
    <section>
        <div class="head">
            <h3>스포츠매치 <span>Prematch</span></h3>
            <button onClick="location.href='/bbs/board.php?bo_table=a10&b_type=2'">전체보기</button>
        </div>
        <div class="box01">

            <h4>
                <img src="/10bet/images/10bet/ico/football-ico.png" class="ico01" alt="ico" /> 축구			
                <img src="/10bet/images/10bet/arrow_01.png" class="arrow" alt="" /> 
                [International] FIFA eSports Battle Premier League (E)		
            </h4>
            <ul>
                <li>
                    <div class="time_arae">01-11 15:20</div>
                    <div class="bet_area">
                        <div class="home">Man City (nikkitta) (E)</div>
                        <div class="vs">VS</div>
                        <div class="away">첼시 (Dangerdim77)</div>
                    </div>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <div class="time_arae">01-11 15:20</div>
                    <div class="bet_area">
                        <div class="home">리버풀 (white_boy1927)</div>
                        <div class="vs">VS</div>
                        <div class="away">토트넘 홋스퍼 (Kodak)</div>
                    </div>
                </li>
            </ul>
            ...
            <h4>
                <img src="/10bet/images/10bet/ico/football-ico.png" class="ico01" alt="ico" /> 축구			
                <img src="/10bet/images/10bet/arrow_01.png" class="arrow" alt="" /> 
                [International] FIFA eSports Battle Serie A (E)		
            </h4>
            <ul>
                <li>
                    <div class="time_arae">01-11 15:26</div>
                    <div class="bet_area">
                        <div class="home">아탈란타 BC (Vrico)</div>
                        <div class="vs">VS</div>
                        <div class="away">인터밀란 (Lomik)</div>
                    </div>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <div class="time_arae">01-11 15:26</div>
                    <div class="bet_area">
                        <div class="home">AC 밀란 (Jkey)</div>
                        <div class="vs">VS</div>
                        <div class="away">SS 라치오 (Plevis)</div>
                    </div>
                </li>
            </ul>
...
<div class="main_minigame">
    <ul>
        ...
        <li>
            <div class="box01 bg03" onClick="location.href='/casino_slot'">
                <h3>10BET
                    <strong>CASINO</strong>
                </h3>
...
<script>
    $j(function() {
        ...
        //setInterval("refresh_graph();", refreshInterval);

        //window.open("http://18.181.168.201:3941/play", "graph" , "width=1440 , height=720 , scrollbars=no , resizable=yes");	
        
        /*setTimeout(function(){
            location.href="/10bet/index.php";
        },5000)*/

    });

    function keep_login() {
        var loc = encodeURIComponent('그래프');
        var obj = {'location' : loc, 'url' : '/bbs/graph.php'};
        $j.ajax({
...
<div id="mobile_foot_menu">
    <ul class="foot_menu">
        ...
        <li><span class="ico_customer"><a href="/10bet/bbs/board.php?bo_table=z10"><img src="/10bet/images/10bet/ico_customer_01.png" alt="고객문의" /></a></span></li>
