                                                                    ...
                                                                    <div class="game_box">
                                                                        <div class="view_section" style="width:58%">
                                                                            <div id="game_view" class="game_view">
                                                                                <iframe class="frameScale" scrolling="no" src="http://scoregame.co.kr/two-ladder/?type=relay" frameborder="0" width="2050" height="1500" style="margin-top:10px; margin-left:3px; left:-624px; top:-330px;"></iframe>
                                                                            </div>
                                                                                ...
                                                                                <div class="bet_cart_box">
                                                                                    <div class="bet_list01">
                                                                                        <div class="list_box01">
                                                                                            ...
                                                                                            <div class="bet_btn01">
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="mini_bet btn_blue" onclick="gameSelect('odd','<?php echo $d2_oe?>');">
                                                                                                        홀
                                                                                                        <span class="bedd"><?php echo $d2_oe?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btn_red" onclick="gameSelect('even','<?php echo $d2_oe?>');">
                                                                                                        짝
                                                                                                        <span class="bedd"><?php echo $d2_oe?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                        ...
                                                                                        <div class="list_box01">
                                                                                            ...
                                                                                            <div class="bet_btn01">
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btn_blue" onclick="gameSelect('left','<?php echo $d2_lr?>');">
                                                                                                        좌
                                                                                                        <span class="bedd"><?php echo $d2_lr?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btn_red" onclick="gameSelect('right','<?php echo $d2_lr?>');">
                                                                                                        우
                                                                                                        <span class="bedd"><?php echo $d2_lr?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                            ...
                                                                                            <div class="bet_btn01">
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btn_blue" onclick="gameSelect('3line','<?php echo $d2_line?>');">
                                                                                                        3줄
                                                                                                        <span class="bedd"><?php echo $d2_line?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btn_red" onclick="gameSelect('4line','<?php echo $d2_line?>');">
                                                                                                        4줄
                                                                                                        <span class="bedd"><?php echo $d2_line?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                        ...
                                                                                        <div class="list_box01">
                                                                                            ...
                                                                                            <div class="bet_btn01">
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btn_blue" onclick="gameSelect('even3line_left','<?php echo $d2_oeline_lr?>');">
                                                                                                        짝
                                                                                                        <span class="bedd"><?php echo $d2_oeline_lr?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btn_red" onclick="gameSelect('odd4line_left','<?php echo $d2_oeline_lr?>');">
                                                                                                        홀
                                                                                                        <span class="bedd"><?php echo $d2_oeline_lr?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                            ...
                                                                                            <div class="bet_btn01">
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btn_blue" onclick="gameSelect('odd3line_right','<?php echo $d2_oeline_lr?>');">
                                                                                                        홀
                                                                                                        <span class="bedd"><?php echo $d2_oeline_lr?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btn_red" onclick="gameSelect('even4line_right','<?php echo $d2_oeline_lr?>');">
                                                                                                        짝
                                                                                                        <span class="bedd"><?php echo $d2_oeline_lr?></span>
                                                                                                    </button>
                                                                                                </div>
...
<script type="text/javascript" src="/include/js/minigame/2dari.js?v=<?php echo time();?>"></script>
<script>
