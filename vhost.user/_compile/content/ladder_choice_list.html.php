<?php
    $choice_bw = $TPL_VAR["mini_odds"]["choice_bw"];
?>
    <div class="mask"></div>
	<div id="container">
...
<!-- 게시판 목록 시작 -->
<script>
    var limit_time = <?php echo $TPL_VAR["mini_config"]["choice_limit"]?>;
    <?php if($TPL_VAR["mini_config"]["choice"] == 0) {?>
        alert('초이스 미니게임은 현재 점검중입니다.\n이용에 불편을 드려 죄송합니다.');
                                            ...
                                            <tr>
                                                <td align="center" valign="top" >
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                                        <tr>
                                                            <td valign="top" width="100%" height="700">
                                                                <!-- 헤더 -->
                                                                <div class="mini_game_bet">
                                                                    <h2>초이스</h2>	
                                                                    <div class="game_box">
                                                                        <div class="view_section" style="width:55%;">
                                                                            <div id="game_view" class="game_view" style="height:800px;">
                                                                                <iframe class="frameScale" scrolling="no" src="https://gamenlives.com/choice/choice.php" frameborder="0" width="700" height="811" style="margin-left:8px;"></iframe>
                                                                            </div>
                                                                        </div>
                                                                        <form name="betForm">
                                                                                ...
                                                                                <div class="bet_cart_box">
                                                                                    <div class="bet_list01">
                                                                                        <div class="list_box01">
                                                                                            ...
                                                                                            <div class="bet_btn01">
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="mini_bet btn_blue" onclick="gameSelect('black','<?php echo $choice_bw?>');">
                                                                                                        Black
                                                                                                        <span class="bedd"><?php echo $choice_bw?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btn_red" onclick="gameSelect('white','<?php echo $choice_bw?>');">
                                                                                                        White
                                                                                                        <span class="bedd"><?php echo $choice_bw?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                    ...
                                                                                    foreach ( $TPL_VAR["betting_list"] as $TPL_K1 => $TPL_V1 ) {
                                                                                        ...
                                                                                        if ( $TPL_item_2 ) { 
                                                                                            ...
                                                                                            foreach ( $TPL_V1["item"] as $TPL_V2 ) {
                                                                                                ...
                                                                                                if ( $gameCode == "choice_bw" ) {
                                                                                                    $gameName = "B/W";
                                                                                                    if ( $TPL_V2["select_no"] == 1 ) {
                                                                                                        $select_val = "<img src=\"/images/mybet_black.png\" >";
                                                                                                    } else {
                                                                                                        $select_val = "<img src=\"/images/mybet_white.png\">";
                                                                                                    }
                                                                                                }
...
<script type="text/javascript" src="/include/js/minigame/choice.js?v=<?php echo time();?>"></script>
<script>
