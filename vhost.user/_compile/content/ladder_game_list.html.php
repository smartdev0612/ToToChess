...
<!-- tab menu -->
	...
	<!-- 중계2 시작-->
	<div id="game_view2" style="position:absolute; top:239px; left:90px; width:935px; height:523px; z-index:90000000; display:none;">
		<div class="ladder_top" style="margin:40px 0 0 53px;">	
			<div id="wrap_ladder" class="ladder_area" style="margin-left:-334px; margin-top:-208px;">		
				<iframe src="http://ladder.named.com/main.php" name="ladder" id="ladder" frameborder="2" scrolling="no" style="width:1229px;height:831px;"></iframe>
			</div>
		</div>
	</div>
	...
	<div style="width:936px;height:892px;overflow:hidden;margin:0 auto; background:url('/images/game_sadari_1.png') 0 0 no-repeat;">
		...
		<div class="ladder_top">
			<div id="wrap_ladder" class="ladder_area" style="left:0px;">
<?php
	if ( $TPL_VAR["named_security_flag"] == 1 ) {
		echo "<img src=\"/images/named_security.jpg\" style=\"margin-top:172px; padding-left:35px;\">";
	} else {
		echo "<iframe width=\"850\" height=\"430\" src=\"http://named.com/game/ladder/v2_index.php\" name=\"ladder\" id=\"ladder\" frameborder=\"0\" scrolling=\"no\"></iframe>";
	}
?>
			</div>
			<!-- 실시간베팅현황 -->
	...
	<div style="width:893px;height:1022px;overflow:hidden;background:url('/images/game_sadari_2.png') 0 0 no-repeat; padding:52px 23px 0 20px;">	
		...
		<div style="height:339px;">
			<iframe id="iframe_sadari_graph" src="/sadari_result_graph" frameborder="0" border="0" scrolling="yes" style="width:893px; height:339px;"></iframe>
		</div>
