    ...
    <div style="margin-left: 20px;margin-top: 40px">
        <div class="ladder_top" style="height:590px; margin:0px;">
            <div id="wrap_ladder" class="ladder_area" style="top:-130px; left:5px; margin-top:130px;">
                <iframe id="pbframe" src="https://rt.ozlive.com/bar/web_live1-2.html" style="width: 920px; height: 640px;" scrolling="no"></iframe>
            </div>
        </div>

        <div style="height:325px;overflow:hidden;margin:5px 0 0 0; background:url('/images/cod/cododdeven_betting_bar.png') 0 0 no-repeat;">
            <div id="list_tableb" style="position:relative;">
                ...
                <ul class="cod_betting1">
                    <li><input class="b_odd" id="gameSt_odd" onclick="gameSelect('odd','1.95');" type="button" value="1.95"></li>
                </ul>
                <ul class="cod_betting11">
                    <li><input class="b_even" id="gameSt_even" onclick="gameSelect('even','1.95');" type="button" value="1.95"></li>
                </ul>
                <ul class="cod_betting2">
                    <li><input class="b_tai" id="gameSt_tai" onclick="gameSelect('tai','7.97');" type="button" value="7.97"></li>
                </ul>
                                ...
                                foreach ( $TPL_VAR["betting_list"] as $TPL_K1 => $TPL_V1 ) {
                                    ...
                                    if ( $TPL_item_2 ) {
                                        ...
                                        foreach ( $TPL_V1["item"] as $TPL_V2 ) {
                                            ...
                                            } else if ( $gameCode == "mgmoddeven_tai" ) {
                                                $gameName = "타이";
...
<script type="text/javascript" src="/include/js/minigame/mgmoddeven.js?v=<?=time();?>"></script>
<script>
