...
jq$(document).ready(function(){
	jq$(".img_btns").hover(function(){
		jq$(this).attr("src", function(index, attr){
			return attr.replace("_d.", "_u.");
		});
	}, function(){
		jq$(this).attr("src", function(index, attr){
			return attr.replace("_u.", "_d.");
		});
	});
...
<div id="contents_left" style="min-height:600px; margin-left:80px;width: 940px;padding: 15px;">
	<div style="width:936px;height:690px;overflow:hidden;margin:0 auto;">
		<div class="ladder_top" style="margin-left:170px; top:0px; height:690px;">
			<div id="wrap_ladder" class="ladder_area" style="margin-left:-165px; top:-519px;">
				<iframe style="width:830px; height:1210px;" src="https://gamenlives.com/9spiel.html" name="ladder" id="ladder" frameborder="0" scrolling="no"></iframe>
			</div>
		</div>
	</div>

		<!-- 사다리 배팅판 -->
    <div style="height:325px;overflow:hidden;margin:5px 0 0 0; background:url('/images/mgmbacara_betting_bar_2.png') 0 0 no-repeat;">
    ...
    <div id="bettingShadow" class="bet_disable" style="top:967px;left:95px;">지금은 베팅을 하실 수 없습니다.</div>
...
<script type="text/javascript" src="/include/js/minigame/nine.js?v=<?php echo time();?>"></script>
<script>
