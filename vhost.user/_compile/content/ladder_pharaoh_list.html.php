<?php
$pharaoh_hs = $TPL_VAR["mini_odds"]["pharaoh_hs"];
?>
    <div class="mask"></div>
	<div id="container">
...
<!-- 게시판 목록 시작 -->
<script>
    var limit_time = <?php echo $TPL_VAR["mini_config"]["pharah_limit"]?>;
    <?php if($TPL_VAR["mini_config"]["pharah"] == 0) {?>
        alert('파라오 미니게임은 현재 점검중입니다.\n이용에 불편을 드려 죄송합니다.');
                                                                ...
                                                                <div class="mini_game_bet">
                                                                    ...
                                                                    <div class="game_box">
                                                                        <div class="view_section" style="width:55%;">
                                                                            <div id="game_view" class="game_view" style="height:850px;">
                                                                                <iframe class="frameScale" scrolling="no" src="https://gamenlives.com/pharaoh/pharaoh.php" frameborder="0" width="700" height="841" style="margin-left:8px;"></iframe>
                                                                            </div>
                                                                        </div>
                                                                        <form name="betForm">
                                                                                ...
                                                                                <div class="bet_cart_box">
                                                                                    <div class="bet_list01">
                                                                                        <div class="list_box01">
                                                                                            ...
                                                                                            <div class="bet_btn01">
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="mini_bet btn_blue" onclick="gameSelect('heart','<?php echo $pharaoh_hs?>');">
                                                                                                        Heart
                                                                                                        <span class="bedd"><?php echo $pharaoh_hs?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btn_red" onclick="gameSelect('spade','<?php echo $pharaoh_hs?>');">
                                                                                                        Spade
                                                                                                        <span class="bedd"><?php echo $pharaoh_hs?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                    ...
                                                                                    foreach ( $TPL_VAR["betting_list"] as $TPL_K1 => $TPL_V1 ) {
                                                                                        ...
                                                                                        if ( $TPL_item_2 ) {
                                                                                            ...
                                                                                            foreach ( $TPL_V1["item"] as $TPL_V2 ) {
                                                                                                ...
                                                                                                if ( $gameCode == "pharaoh_hs" ) {
                                                                                                    $gameName = "H/S";
                                                                                                    if ( $TPL_V2["select_no"] == 1 ) {
                                                                                                        $select_val = "<img src=\"/images/mybet_heart.png\">";
                                                                                                    } else {
                                                                                                        $select_val = "<img src=\"/images/mybet_spade.png\">";
                                                                                                    }
                                                                                                }
...
<script type="text/javascript" src="/include/js/minigame/pharaoh.js?v=<?php echo time();?>"></script>
<script>
