                                                                            ...
                                                                            <div id="gamelist" class="bet_section" style="width:100%;">
                                                                                <div class="bet_cart_box">
                                                                                    ...
                                                                                    <div class="bet_cart">
                                                                                        ...
                                                                                        <div class="bet_moeny">
                                                                                            배팅금액
                                                                                            <input type="text" id="btMoney" name="btMoney" class="input_betmoney" value="0" onkeyUp="moneyPlusManual(this.value);" placeholder="0">
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="bet_cart_box">
                                                                                    <div class="bet_list01">
                                                                                        <div class="list_box01">
                                                                                            ...
                                                                                            <div class="bet_btn01">
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btnBet btn_odd btn_blue" onclick="gameSelect('odd','<?php echo $oe?>');">
                                                                                                        홀
                                                                                                        <span class="bedd"><?php echo $oe?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btnBet btn_even btn_red" onclick="gameSelect('even','<?php echo $oe?>');">
                                                                                                        짝
                                                                                                        <span class="bedd"><?php echo $oe?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                        ...
                                                                                        <div class="list_box01">
                                                                                            ...
                                                                                            <div class="bet_btn01">
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btnBet btn_left btn_blue" onclick="gameSelect('left','<?php echo $lr?>');">
                                                                                                        좌
                                                                                                        <span class="bedd"><?php echo $lr?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btnBet btn_right btn_red" onclick="gameSelect('right','<?php echo $lr?>');">
                                                                                                        우
                                                                                                        <span class="bedd"><?php echo $lr?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                        ...
                                                                                        <div class="list_box01">
                                                                                            ...
                                                                                            <div class="bet_btn01">
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btnBet btn_3line btn_blue" onclick="gameSelect('3line','<?php echo $line?>');">
                                                                                                        3줄
                                                                                                        <span class="bedd"><?php echo $line?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btnBet btn_4line btn_red" onclick="gameSelect('4line','<?php echo $line?>');">
                                                                                                        4줄
                                                                                                        <span class="bedd"><?php echo $line?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                        ...
                                                                                        <div class="list_box01">
                                                                                            ...
                                                                                            <div class="bet_btn01">
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btnBet btn_even3line_left btn_blue" onclick="gameSelect('even3line_left','<?php echo $oeline_lr?>');">
                                                                                                        짝좌3줄
                                                                                                        <span class="bedd"><?php echo $oeline_lr?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btnBet btn_odd4line_left btn_red" onclick="gameSelect('odd4line_left','<?php echo $oeline_lr?>');">
                                                                                                        홀좌4줄
                                                                                                        <span class="bedd"><?php echo $oeline_lr?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                            ...
                                                                                            <div class="bet_btn01">
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btnBet btn_odd3line_right btn_blue" onclick="gameSelect('odd3line_right','<?php echo $oeline_lr?>');">
                                                                                                        홀우3줄
                                                                                                        <span class="bedd"><?php echo $oeline_lr?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                <div class="btn01">
                                                                                                    <button type="button" class="btnBet btn_even4line_right btn_red" onclick="gameSelect('even4line_right','<?php echo $oeline_lr?>');">
                                                                                                        짝우4줄
                                                                                                        <span class="bedd"><?php echo $oeline_lr?></span>
                                                                                                    </button>
                                                                                                </div>
                                                                                    ...
                                                                                    foreach ( $TPL_VAR["betting_list"] as $TPL_K1 => $TPL_V1 ) {
                                                                                        ...
                                                                                        if ( $TPL_item_2 ) { 
                                                                                            ...
                                                                                            foreach ( $TPL_V1["item"] as $TPL_V2 ) {
                                                                                                ...
                                                                                                $btNo = $forCnt;
                                                                                                echo "<tr>
                                                                                                        <td style=\"font-weight:bold;\">{$gameTh}</td>
...
<script type="text/javascript" src="/include/js/minigame/powersadari.js?v=<?php echo time();?>"></script>
<script>
