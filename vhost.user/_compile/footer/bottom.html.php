...
<script>
    ...
    function getTodayGameInfo() {
        ...
        $j.post("/getTodayGameInfo", function(res){ 
            console.log(res);
            var json = JSON.parse(res);
            for(var i = 0; i < json.length; i++) {
                switch(json[i].sport_name) {
                    case "축구":
                        var div_soccer = "";
                        div_soccer += '<ul class="li-soccer" onclick=showLeagues("ul-soccer-' + json[i].nation_sn + '") style="display:none; width:97%; margin-left:7px;">';
                        div_soccer += '<li class="menu2">';
                        div_soccer += '<a href="javascript:void(0)" class="st_marl10 menu2-a">';
                        div_soccer += '<img src="' + json[i].nation_img + '" width="15" class="menu2-img">'; 
                        div_soccer += json[i].nation_name;									
                        div_soccer += '<span class="f_right _center w35 menu2-span" style="margin-right:10px;">' + json[i].nation_cnt + '</span>';
                        div_soccer += '</a>';
                        div_soccer += '</li>';
                        div_soccer += '</ul>';
                        div_soccer += '<ul class="ul-soccer ul-soccer-' + json[i].nation_sn + ' sub-ul" style="display:none;">';
                        for(var j = 0; j < json[i].items.length; j++){
                            div_soccer += `<li class="ss_bl1 li-bg" onClick="location.href='/game_list?game=abroad&sport=soccer&league_sn=` + json[i].items[j].league_sn + `&today=0'"`;
                            div_soccer += '<a href="javascript:void(0)">';
                            div_soccer += '<p class="txt_line1 _limit _w180 p-badge">' + json[i].items[j].league_name + '</p>';
                            div_soccer += '<span class="badge badge-info f_right _center w35 span-badge">' + json[i].items[j].league_cnt + '</span>';
                            div_soccer += '</a>';
                            div_soccer += '</li>';
                        }
                        div_soccer += '</ul>';
                    ...
                    case "농구":
                        var div_bask = "";
                        div_bask += '<ul class="li-bask"  onclick=showLeagues("ul-bask-' + json[i].nation_sn + '") style="display:none; width:97%; margin-left:7px;">';
                        div_bask += '<li class="menu2">';
                        div_bask += '<a href="javascript:void(0)" class="st_marl10 menu2-a">';
                        div_bask += '<img src="' + json[i].nation_img + '" width="15" class="menu2-img">'; 
                        div_bask += json[i].nation_name;									
                        div_bask += '<span class="f_right _center w35 menu2-span" style="margin-right:10px;">' + json[i].nation_cnt + '</span>';
                        div_bask += '</a>';
                        div_bask += '</li>';
                        div_bask += '</ul>';
                        div_bask += '<ul class="ul-bask ul-bask-' + json[i].nation_sn + ' sub-ul" style="display:none;">';
                        for(var j = 0; j < json[i].items.length; j++){
                            div_bask += `<li class="ss_bl1 li-bg" onClick="location.href='/game_list?game=abroad&sport=basketball&league_sn=` + json[i].items[j].league_sn + `&today=0'"`;
                            div_bask += '<a href="javascript:void(0)">';
                            div_bask += '<p class="txt_line1 _limit _w180 p-badge">' + json[i].items[j].league_name + '</p>';
                            div_bask += '<span class="badge badge-info f_right _center w35 span-badge">' + json[i].items[j].league_cnt + '</span>';
                            div_bask += '</a>';
                            div_bask += '</li>';
                        }
                        div_bask += '</ul>';
                    ...
                    case "야구":
                        var div_base = "";
                        div_base += '<ul class="li-base"  onclick=showLeagues("ul-base-' + json[i].nation_sn + '") style="display:none; width:97%; margin-left:7px;">';
                        div_base += '<li class="menu2">';
                        div_base += '<a href="javascript:void(0)" class="st_marl10 menu2-a">';
                        div_base += '<img src="' + json[i].nation_img + '" width="15" class="menu2-img">'; 
                        div_base += json[i].nation_name;									
                        div_base += '<span class="f_right _center w35 menu2-span" style="margin-right:10px;">' + json[i].nation_cnt + '</span>';
                        div_base += '</a>';
                        div_base += '</li>';
                        div_base += '</ul>';
                        div_base += '<ul class="ul-base ul-base-' + json[i].nation_sn + ' sub-ul" style="display:none;">';
                        for(var j = 0; j < json[i].items.length; j++){
                            div_base += `<li class="ss_bl1 li-bg" onClick="location.href='/game_list?game=abroad&sport=baseball&league_sn=` + json[i].items[j].league_sn + `&today=0'"`;
                            div_base += '<a href="javascript:void(0)">';
                            div_base += '<p class="txt_line1 _limit _w180 p-badge">' + json[i].items[j].league_name + '</p>';
                            div_base += '<span class="badge badge-info f_right _center w35 span-badge">' + json[i].items[j].league_cnt + '</span>';
                            div_base += '</a>';
                            div_base += '</li>';
                        }
                        div_base += '</ul>';
                    ...
                    case "아이스 하키":
                        var div_hock = "";
                        div_hock += '<ul class="li-hock"  onclick=showLeagues("ul-hock-' + json[i].nation_sn + '") style="display:none; width:97%; margin-left:7px;">';
                        div_hock += '<li class="menu2">';
                        div_hock += '<a href="javascript:void(0)" class="st_marl10 menu2-a">';
                        div_hock += '<img src="' + json[i].nation_img + '" width="15" class="menu2-img">'; 
                        div_hock += json[i].nation_name;									
                        div_hock += '<span class="f_right _center w35 menu2-span" style="margin-right:10px;">' + json[i].nation_cnt + '</span>';
                        div_hock += '</a>';
                        div_hock += '</li>';
                        div_hock += '</ul>';
                        div_hock += '<ul class="ul-hock ul-hock-' + json[i].nation_sn + ' sub-ul" style="display:none;">';
                        for(var j = 0; j < json[i].items.length; j++){
                            div_hock += `<li class="ss_bl1 li-bg" onClick="location.href='/game_list?game=abroad&sport=hockey&league_sn=` + json[i].items[j].league_sn + `&today=0'"`;
                            div_hock += '<a href="javascript:void(0)">';
                            div_hock += '<p class="txt_line1 _limit _w180 p-badge">' + json[i].items[j].league_name + '</p>';
                            div_hock += '<span class="badge badge-info f_right _center w35 span-badge">' + json[i].items[j].league_cnt + '</span>';
                            div_hock += '</a>';
                            div_hock += '</li>';
                        }
                        div_hock += '</ul>';
                    ...
                    case "배구":
                        var div_val = "";
                        div_val += '<ul class="li-val"  onclick=showLeagues("ul-val-' + json[i].nation_sn + '") style="display:none; width:97%; margin-left:7px;">';
                        div_val += '<li class="menu2">';
                        div_val += '<a href="javascript:void(0)" class="st_marl10 menu2-a">';
                        div_val += '<img src="' + json[i].nation_img + '" width="15" class="menu2-img">'; 
                        div_val += json[i].nation_name;									
                        div_val += '<span class="f_right _center w35 menu2-span" style="margin-right:10px;">' + json[i].nation_cnt + '</span>';
                        div_val += '</a>';
                        div_val += '</li>';
                        div_val += '</ul>';
                        div_val += '<ul class="ul-val ul-val-' + json[i].nation_sn + ' sub-ul" style="display:none;">';
                        for(var j = 0; j < json[i].items.length; j++){
                            div_val += `<li class="ss_bl1 li-bg" onClick="location.href='/game_list?game=abroad&sport=volleyball&league_sn=` + json[i].items[j].league_sn + `&today=0'"`;
                            div_val += '<a href="javascript:void(0)">';
                            div_val += '<p class="txt_line1 _limit _w180 p-badge">' + json[i].items[j].league_name + '</p>';
                            div_val += '<span class="badge badge-info f_right _center w35 span-badge">' + json[i].items[j].league_cnt + '</span>';
                            div_val += '</a>';
                            div_val += '</li>';
                        }
                        div_val += '</ul>';
