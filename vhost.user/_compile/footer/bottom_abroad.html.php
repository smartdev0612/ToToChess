                ...
                $.each(res, function(index, item) {
                    switch(item.sport_name) {
                        case "축구":
                            ...
                            div_soccer += '<li class="menu2" style="line-height:30px !important;">';
                            ...
                            $.each(item.items, function(i, league){
                                div_soccer += "<li class='ss_bl1 li-bg' onclick=getGameList('0','soccer','" + league.league_sn + "','1')>";
                        ...
                        case "농구":
                            ...
                            div_bask += '<li class="menu2" style="line-height:30px !important;">';
                            ...
                            $.each(item.items, function(i, league){
                                div_bask += "<li class='ss_bl1 li-bg' onclick=getGameList('0','basketball','" + league.league_sn + "','1')>";
                        ...
                        case "야구":
                            ...
                            div_base += '<li class="menu2" style="line-height:30px !important;">';
                            ...
                            $.each(item.items, function(i, league){
                                div_base += "<li class='ss_bl1 li-bg' onclick=getGameList('0','baseball','" + league.league_sn + "','1')>";
                        ...
                        case "아이스 하키":
                            ...
                            div_hock += '<li class="menu2" style="line-height:30px !important;">';
                            ...
                            $.each(item.items, function(i, league){
                                div_hock += "<li class='ss_bl1 li-bg' onclick=getGameList('0','hockey','" + league.league_sn + "','1')>";
                        ...
                        case "배구":
                            ...
                            div_val += '<li class="menu2" style="line-height:30px !important;">';
                            ...
                            $.each(item.items, function(i, league){
                                div_val += "<li class='ss_bl1 li-bg' onclick=getGameList('0','volleyball','" + league.league_sn + "','1')>";
