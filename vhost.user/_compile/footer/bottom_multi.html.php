                ...
                switch(json[i].sport_name) {
                    case "축구":
                        ...
                        for(var j = 0; j < json[i].items.length; j++){
                            div_soccer += "<li class='ss_bl1 li-bg' onclick=getClassicGameList('0','soccer','" + json[i].items[j].league_sn + "','1')>";
                    ...
                    case "농구":
                        ...
                        for(var j = 0; j < json[i].items.length; j++){
                            div_bask += "<li class='ss_bl1 li-bg' onclick=getClassicGameList('0','basketball','" + json[i].items[j].league_sn + "','1')>";
                    ...
                    case "야구":
                        ...
                        for(var j = 0; j < json[i].items.length; j++){
                            div_base += "<li class='ss_bl1 li-bg' onclick=getClassicGameList('0','baseball','" + json[i].items[j].league_sn + "','1')>";
                    ...
                    case "아이스 하키":
                        ...
                        for(var j = 0; j < json[i].items.length; j++){
                            div_hock += "<li class='ss_bl1 li-bg' onclick=getClassicGameList('0','hockey','" + json[i].items[j].league_sn + "','1')>";
                    ...
                    case "배구":
                        ...
                        for(var j = 0; j < json[i].items.length; j++){
                            div_val += "<li class='ss_bl1 li-bg' onclick=getClassicGameList('0','volleyball','" + json[i].items[j].league_sn + "','1')>";
