    ...
    <?php
        if(count((array)$_SESSION['member']) > 0) { ?>
            ...
            <div class="user_box box_type01">
                <div class="user_name"><img src='/images/level_icon_<?php echo $TPL_VAR["level"]?>.png?v=2' style="margin-top:6px;">&nbsp;&nbsp;&nbsp; <?=$TPL_VAR["nick"]?></div>
                <div class="money">
        ...
        <div class="betting_cart box_type01">
            <h3><img src="/10bet/images/10bet/ico_slot_01_01.png" alt="" /> 슬롯보유금액</h3>
