...
// github.com/t4t5/sweetalert
        ...
        var _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation = require('./modules/handle-dom');

        /*
         * Handy utilities
         */

        var _extendjq$hexToRgbjq$isIE8jq$logStrjq$colorLuminance = require('./modules/utils');

        /*
         *  Handle sweetAlert's DOM elements
         */

        var _sweetAlertInitializejq$getModaljq$getOverlayjq$getInputjq$setFocusStylejq$openModaljq$resetInputjq$fixVerticalPosition = require('./modules/handle-swal-dom');

// Handle button events and keyboard events

        var _handleButtonjq$handleConfirmjq$handleCancel = require('./modules/handle-click');
...
// Default values
        ...
        exports['default'] = sweetAlert = swal = function () {
            ...
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.addClass(document.body, 'stop-scrolling');
            _sweetAlertInitializejq$getModaljq$getOverlayjq$getInputjq$setFocusStylejq$openModaljq$resetInputjq$fixVerticalPosition.resetInput();
            ...
            if (customizations === undefined) {
                _extendjq$hexToRgbjq$isIE8jq$logStrjq$colorLuminance.logStr('SweetAlert expects at least 1 attribute!');
                return false;
            }

            var params = _extendjq$hexToRgbjq$isIE8jq$logStrjq$colorLuminance.extend({}, _defaultParams2['default']);
            ...
            switch (typeof customizations) {
                ...
                case 'object':
                    if (customizations.title === undefined) {
                        _extendjq$hexToRgbjq$isIE8jq$logStrjq$colorLuminance.logStr('Missing "title" argument!');
                        return false;
                    }
                ...
                default:
                    _extendjq$hexToRgbjq$isIE8jq$logStrjq$colorLuminance.logStr('Unexpected type of argument! Expected "string" or "object", got ' + typeof customizations);
                    return false;

            }

            _setParameters2['default'](params);
            _sweetAlertInitializejq$getModaljq$getOverlayjq$getInputjq$setFocusStylejq$openModaljq$resetInputjq$fixVerticalPosition.fixVerticalPosition();
            _sweetAlertInitializejq$getModaljq$getOverlayjq$getInputjq$setFocusStylejq$openModaljq$resetInputjq$fixVerticalPosition.openModal(arguments[1]);

            // Modal interactions
            var modal = _sweetAlertInitializejq$getModaljq$getOverlayjq$getInputjq$setFocusStylejq$openModaljq$resetInputjq$fixVerticalPosition.getModal();

            /*
             * Make sure all modal buttons respond to all events
             */
            var jq$buttons = modal.querySelectorAll('button');
            var buttonEvents = ['onclick', 'onmouseover', 'onmouseout', 'onmousedown', 'onmouseup', 'onfocus'];
            var onButtonEvent = function onButtonEvent(e) {
                return _handleButtonjq$handleConfirmjq$handleCancel.handleButton(e, params, modal);
            };

            for (var btnIndex = 0; btnIndex < jq$buttons.length; btnIndex++) {
                for (var evtIndex = 0; evtIndex < buttonEvents.length; evtIndex++) {
                    var btnEvt = buttonEvents[evtIndex];
                    jq$buttons[btnIndex][btnEvt] = onButtonEvent;
                }
            }

            // Clicking outside the modal dismisses it (if allowed by user)
            _sweetAlertInitializejq$getModaljq$getOverlayjq$getInputjq$setFocusStylejq$openModaljq$resetInputjq$fixVerticalPosition.getOverlay().onclick = onButtonEvent;
        ...
        sweetAlert.setDefaults = swal.setDefaults = function (userParams) {
            ...
            _extendjq$hexToRgbjq$isIE8jq$logStrjq$colorLuminance.extend(_defaultParams2['default'], userParams);
        };
        ...
        sweetAlert.close = swal.close = function () {
            ...
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.fadeOut(_sweetAlertInitializejq$getModaljq$getOverlayjq$getInputjq$setFocusStylejq$openModaljq$resetInputjq$fixVerticalPosition.getOverlay(), 5);
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.fadeOut(modal, 5);
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(modal, 'showSweetAlert');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.addClass(modal, 'hideSweetAlert');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(modal, 'visible');

            /*
             * Reset icon animations
             */
            var jq$successIcon = modal.querySelector('.sa-icon.sa-success');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(jq$successIcon, 'animate');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(jq$successIcon.querySelector('.sa-tip'), 'animateSuccessTip');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(jq$successIcon.querySelector('.sa-long'), 'animateSuccessLong');

            var jq$errorIcon = modal.querySelector('.sa-icon.sa-error');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(jq$errorIcon, 'animateErrorIcon');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(jq$errorIcon.querySelector('.sa-x-mark'), 'animateXMark');

            var jq$warningIcon = modal.querySelector('.sa-icon.sa-warning');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(jq$warningIcon, 'pulseWarning');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(jq$warningIcon.querySelector('.sa-body'), 'pulseWarningIns');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(jq$warningIcon.querySelector('.sa-dot'), 'pulseWarningIns');

            // Reset custom class (delay so that UI changes aren't visible)
            setTimeout(function () {
                var customClass = modal.getAttribute('data-custom-class');
                _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(modal, customClass);
            }, 300);

            // Make page scrollable again
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(document.body, 'stop-scrolling');
        ...
        sweetAlert.showInputError = swal.showInputError = function (errorMessage) {
            ...
            var jq$errorIcon = modal.querySelector('.sa-input-error');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.addClass(jq$errorIcon, 'show');

            var jq$errorContainer = modal.querySelector('.sa-error-container');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.addClass(jq$errorContainer, 'show');

            jq$errorContainer.querySelector('p').innerHTML = errorMessage;
        ...
        sweetAlert.resetInputError = swal.resetInputError = function (event) {
            ...
            var jq$modal = _sweetAlertInitializejq$getModaljq$getOverlayjq$getInputjq$setFocusStylejq$openModaljq$resetInputjq$fixVerticalPosition.getModal();

            var jq$errorIcon = jq$modal.querySelector('.sa-input-error');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(jq$errorIcon, 'show');

            var jq$errorContainer = jq$modal.querySelector('.sa-error-container');
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hidejq$isDescendantjq$getTopMarginjq$fadeInjq$fadeOutjq$fireClickjq$stopEventPropagation.removeClass(jq$errorContainer, 'show');
        };
        ...
        sweetAlert.disableButtons = swal.disableButtons = function (event) {
            var modal = _sweetAlertInitializejq$getModaljq$getOverlayjq$getInputjq$setFocusStylejq$openModaljq$resetInputjq$fixVerticalPosition.getModal();
            var jq$confirmButton = modal.querySelector('button.confirm');
            var jq$cancelButton = modal.querySelector('button.cancel');
            jq$confirmButton.disabled = true;
            jq$cancelButton.disabled = true;
        };
        ...
        sweetAlert.enableButtons = swal.enableButtons = function (event) {
            ...
            var jq$confirmButton = modal.querySelector('button.confirm');
            var jq$cancelButton = modal.querySelector('button.cancel');
            jq$confirmButton.disabled = false;
            jq$cancelButton.disabled = false;
        };
        ...
        if (typeof window !== 'undefined') {
            ...
            _extendjq$hexToRgbjq$isIE8jq$logStrjq$colorLuminance.logStr('SweetAlert is a frontend module!');
        }
        ...
        var _hasClassjq$isDescendant = require('./handle-dom');
        ...
        var handleButton = function handleButton(event, params, modal) {
            ...
            var modalIsVisible = _hasClassjq$isDescendant.hasClass(modal, 'visible');
            ...
            switch (e.type) {
                ...
                case 'focus':
                    ...
                    if (targetedConfirm) {
                        jq$cancelButton.style.boxShadow = 'none';
                    } else {
                        jq$confirmButton.style.boxShadow = 'none';
                    }
                    break;

                case 'click':
                    var clickedOnModal = modal === target;
                    var clickedOnModalChild = _hasClassjq$isDescendant.isDescendant(modal, target);
                    ...
                    } else if (_hasClassjq$isDescendant.isDescendant(modal, target) && target.tagName === 'BUTTON') {
                        sweetAlert.close();
                    }
                    break;
            }
        ...
        var handleConfirm = function handleConfirm(modal, params) {
            ...
            if (_hasClassjq$isDescendant.hasClass(modal, 'show-input')) {
        ...
        var removeClass = function removeClass(elem, className) {
            ...
            if (hasClass(elem, className)) {
                ...
                elem.className = newClass.replace(/^\s+|\s+jq$/g, '');
            }
        };
        ...
        var _stopEventPropagationjq$fireClick = require('./handle-dom');
        ...
        var handleKeyDown = function handleKeyDown(event, params, modal) {
            ...
            var jq$okButton = modal.querySelector('button.confirm');
            var jq$cancelButton = modal.querySelector('button.cancel');
            var jq$modalButtons = modal.querySelectorAll('button[tabindex]');
            ...
            var jq$targetElement = e.target || e.srcElement;

            var btnIndex = -1; // Find the button - note, this is a nodelist, not an array.
            for (var i = 0; i < jq$modalButtons.length; i++) {
                if (jq$targetElement === jq$modalButtons[i]) {
                    btnIndex = i;
                    break;
                }
            }
            ...
            if (keyCode === 9) {
                ...
                if (btnIndex === -1) {
                    ...
                    jq$targetElement = jq$okButton;
                } else {
                    // Cycle to the next button
                    if (btnIndex === jq$modalButtons.length - 1) {
                        jq$targetElement = jq$modalButtons[0];
                    } else {
                        jq$targetElement = jq$modalButtons[btnIndex + 1];
                    }
                }

                _stopEventPropagationjq$fireClick.stopEventPropagation(e);
                jq$targetElement.focus();

                if (params.confirmButtonColor) {
                    _setFocusStyle.setFocusStyle(jq$targetElement, params.confirmButtonColor);
                }
            } else {
                if (keyCode === 13) {
                    if (jq$targetElement.tagName === 'INPUT') {
                        jq$targetElement = jq$okButton;
                        jq$okButton.focus();
                    }
                    ...
                    if (btnIndex === -1) {
                        ...
                        jq$targetElement = undefined;
                    }
                } else if (keyCode === 27 && params.allowEscapeKey === true) {
                    jq$targetElement = jq$cancelButton;
                    _stopEventPropagationjq$fireClick.fireClick(jq$targetElement, e);
                } else {
        ...
        var _removeClassjq$getTopMarginjq$fadeInjq$showjq$addClass = require('./handle-dom');
        ...
        var getModal = (function (_getModal) {
            ...
            var jq$modal = document.querySelector(modalClass);
        ...
        var getInput = function getInput() {
            var jq$modal = getModal();
            if (jq$modal) {
                return jq$modal.querySelector('input');
            }
        };
         ...
         */
        var setFocusStyle = function setFocusStyle(jq$button, bgColor) {
            var rgbColor = _hexToRgb.hexToRgb(bgColor);
            jq$button.style.boxShadow = '0 0 2px rgba(' + rgbColor + ', 0.8), inset 0 0 0 1px rgba(0, 0, 0, 0.05)';
        };
        ...
        var openModal = function openModal(callback) {
            var jq$modal = getModal();
            _removeClassjq$getTopMarginjq$fadeInjq$showjq$addClass.fadeIn(getOverlay(), 10);
            _removeClassjq$getTopMarginjq$fadeInjq$showjq$addClass.show(jq$modal);
            _removeClassjq$getTopMarginjq$fadeInjq$showjq$addClass.addClass(jq$modal, 'showSweetAlert');
            _removeClassjq$getTopMarginjq$fadeInjq$showjq$addClass.removeClass(jq$modal, 'hideSweetAlert');

            window.previousActiveElement = document.activeElement;
            var jq$okButton = jq$modal.querySelector('button.confirm');
            jq$okButton.focus();

            setTimeout(function () {
                _removeClassjq$getTopMarginjq$fadeInjq$showjq$addClass.addClass(jq$modal, 'visible');
            }, 500);

            var timer = jq$modal.getAttribute('data-timer');

            if (timer !== 'null' && timer !== '') {
                var timerCallback = callback;
                jq$modal.timeout = setTimeout(function () {
                    var doneFunctionExists = (timerCallback || null) && jq$modal.getAttribute('data-has-done-function') === 'true';
        ...
        var resetInput = function resetInput() {
            var jq$modal = getModal();
            var jq$input = getInput();

            _removeClassjq$getTopMarginjq$fadeInjq$showjq$addClass.removeClass(jq$modal, 'show-input');
            jq$input.value = _defaultParams2['default'].inputValue;
            jq$input.setAttribute('type', _defaultParams2['default'].inputType);
            jq$input.setAttribute('placeholder', _defaultParams2['default'].inputPlaceholder);
        ...
        var resetInputError = function resetInputError(event) {
            ...
            var jq$errorIcon = jq$modal.querySelector('.sa-input-error');
            _removeClassjq$getTopMarginjq$fadeInjq$showjq$addClass.removeClass(jq$errorIcon, 'show');

            var jq$errorContainer = jq$modal.querySelector('.sa-error-container');
            _removeClassjq$getTopMarginjq$fadeInjq$showjq$addClass.removeClass(jq$errorContainer, 'show');
        };
        ...
        var fixVerticalPosition = function fixVerticalPosition() {
            var jq$modal = getModal();
            jq$modal.style.marginTop = _removeClassjq$getTopMarginjq$fadeInjq$showjq$addClass.getTopMargin(getModal());
        };
...
// Dark overlay
        ...
        var _getModaljq$getInputjq$setFocusStyle = require('./handle-swal-dom');

        var _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide = require('./handle-dom');
        ...
        var setParameters = function setParameters(params) {
            var modal = _getModaljq$getInputjq$setFocusStyle.getModal();

            var jq$title = modal.querySelector('h2');
            var jq$text = modal.querySelector('p');
            var jq$cancelBtn = modal.querySelector('button.cancel');
            var jq$confirmBtn = modal.querySelector('button.confirm');

            /*
             * Title
             */
            jq$title.innerHTML = params.html ? params.title : _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.escapeHtml(params.title).split('\n').join('<br>');

            /*
             * Text
             */
            jq$text.innerHTML = params.html ? params.text : _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.escapeHtml(params.text || '').split('\n').join('<br>');
            if (params.text) _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.show(jq$text);

            /*
             * Custom class
             */
            if (params.customClass) {
                _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.addClass(modal, params.customClass);
                modal.setAttribute('data-custom-class', params.customClass);
            } else {
                // Find previously set classes and remove them
                var customClass = modal.getAttribute('data-custom-class');
                _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.removeClass(modal, customClass);
             ...
             * Icon
             */
            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.hide(modal.querySelectorAll('.sa-icon'));
            ...
            if (params.type && !_isIE8.isIE8()) {
                var _ret = (function () {
                    ...
                    var jq$icon = undefined;

                    if (typesWithIcons.indexOf(params.type) !== -1) {
                        jq$icon = modal.querySelector('.sa-icon.' + 'sa-' + params.type);
                        _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.show(jq$icon);
                    }

                    var jq$input = _getModaljq$getInputjq$setFocusStyle.getInput();

                    // Animate icon
                    switch (params.type) {

                        case 'success':
                            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.addClass(jq$icon, 'animate');
                            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.addClass(jq$icon.querySelector('.sa-tip'), 'animateSuccessTip');
                            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.addClass(jq$icon.querySelector('.sa-long'), 'animateSuccessLong');
                            break;

                        case 'error':
                            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.addClass(jq$icon, 'animateErrorIcon');
                            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.addClass(jq$icon.querySelector('.sa-x-mark'), 'animateXMark');
                            break;

                        case 'warning':
                            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.addClass(jq$icon, 'pulseWarning');
                            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.addClass(jq$icon.querySelector('.sa-body'), 'pulseWarningIns');
                            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.addClass(jq$icon.querySelector('.sa-dot'), 'pulseWarningIns');
                            break;

                        case 'input':
                        case 'prompt':
                            jq$input.setAttribute('type', params.inputType);
                            jq$input.value = params.inputValue;
                            jq$input.setAttribute('placeholder', params.inputPlaceholder);
                            _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.addClass(modal, 'show-input');
                            setTimeout(function () {
                                jq$input.focus();
                                jq$input.addEventListener('keyup', swal.resetInputError);
                            }, 400);
                            break;
                    }
                })();
             ...
             */
            if (params.imageUrl) {
                var jq$customIcon = modal.querySelector('.sa-icon.sa-custom');

                jq$customIcon.style.backgroundImage = 'url(' + params.imageUrl + ')';
                _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.show(jq$customIcon);
                ...
                jq$customIcon.setAttribute('style', jq$customIcon.getAttribute('style') + 'width:' + _imgWidth + 'px; height:' + _imgHeight + 'px');
            }
            ...
            if (params.showCancelButton) {
                jq$cancelBtn.style.display = 'inline-block';
            } else {
                _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.hide(jq$cancelBtn);
            }
            ...
            if (params.showConfirmButton) {
                jq$confirmBtn.style.display = 'inline-block';
            } else {
                _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.hide(jq$confirmBtn);
            }
            ...
            if (params.cancelButtonText) {
                jq$cancelBtn.innerHTML = _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.escapeHtml(params.cancelButtonText);
            }
            if (params.confirmButtonText) {
                jq$confirmBtn.innerHTML = _hasClassjq$addClassjq$removeClassjq$escapeHtmljq$_showjq$showjq$_hidejq$hide.escapeHtml(params.confirmButtonText);
            }
            ...
            if (params.confirmButtonColor) {
                ...
                jq$confirmBtn.style.backgroundColor = params.confirmButtonColor;

                // Set the confirm button color to the loading ring
                jq$confirmBtn.style.borderLeftColor = params.confirmLoadingButtonColor;
                jq$confirmBtn.style.borderRightColor = params.confirmLoadingButtonColor;

                // Set box-shadow to default focused button
                _getModaljq$getInputjq$setFocusStyle.setFocusStyle(jq$confirmBtn, params.confirmButtonColor);
            }
        ...
        var hexToRgb = function hexToRgb(hex) {
            var result = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})jq$/i.exec(hex);
