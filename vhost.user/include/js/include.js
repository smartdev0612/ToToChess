...
function getMarketsCnt(sport_name, children, isExist12 = true) {
    ...
    switch(sport_name) {
        ...
        case "배구":
            ...
            break;
        case "야구":
            marketArray = [226, 342, 28, 220, 221, 235, 41, 42, 43, 44, 348, 349, 524, 2057, 281, 447, 448, 526, 449, 450, 21, 45, 46, 1562, 47, 48, 236, 352, 525, 353, 6];
            break;
        case "아이스 하키":
            marketArray = [1, 342, 28, 7, 202, 41, 42, 43, 44, 64, 65, 66, 221, 220, 21, 45, 46, 51];
            break;
        case "E스포츠":
            marketArray = [52, 3, 2, 6, 202, 203, 204, 205, 206, 64, 65, 66, 67, 68, 1149, 1150, 1151, 1152, 1153, 989, 990, 991, 1165, 1166, 1167, 1168, 1169, 669, 670, 671, 1170, 1171, 1172, 1173, 1174, 1251, 1252, 1253, 1254, 1255, 672, 673, 674, 666, 667, 668, 679, 680, 681, 1162, 1163, 1164, 1129, 1130, 1131, 1133, 1134, 1135];
            break;
    }
