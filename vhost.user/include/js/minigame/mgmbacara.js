	...
	function realTime() {
		...
		gameTh = Math.floor(secTemp / 60) + 1;
		jq$("#viewGameTh").html(gameTh);

		secTemp = (gameTh * 60) - secTemp;
		if ( secTemp < 60 ) {
			secTempMin = "00";
	...
	function gameBetting() {
		...
		var postData = {"btGameName":"mgmbacara", "btGameTh":gameTh, "btMoney":bet_money, "btGameType":selectGameType};
