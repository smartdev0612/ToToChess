	...
	function realTime() {
		...
		gameTh = Math.floor(secTemp / 90) + 1;
		jq$("#viewGameTh").html(gameTh);

		secTemp = (gameTh * 90) - secTemp;
		if ( secTemp < 60 ) {
			secTempMin = "00";
	...
	function gameBetting() {
		...
		var postData = {"btGameName":"minibacara", "btGameTh":gameTh, "btMoney":bet_money, "btGameType":selectGameType};
