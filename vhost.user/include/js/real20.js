...
(function () {
    ...
    var optionsController = {
        ...
        frameTwo: {
            ...
            status: {
                frame: $("dl.new20_betting3").find(".__game_status"),
                type: $("dl.new20_betting3").find(".__game_type"),
                allocation: $("dl.new20_betting3").find(".__game_allocation")
            }
        },
        frameThree: {
            batting: $('ul.new20_betting1').find('a'),
            directInput: $('.new20_betting_input2').find('.__game_moneydirect'),
            status: {
                money1: $('div.new20_betting_input1').find('.__game_money1'),
                money2: $('div.new20_betting_input1').find('.__game_money2')
            }
        },
        battingSubmit: $('.new20_betting2').find('.__game_batting')
    };
